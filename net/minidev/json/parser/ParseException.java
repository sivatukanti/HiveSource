...
public class ParseException extends Exception
{
    ...
    public ParseException(final int position, final Throwable cause) {
    ...
    private static String toMessage(final int position, final int errorType, final Object unexpectedObject) {
