    ...
    public static final UnboundRecordFilter or(final UnboundRecordFilter filter1, final UnboundRecordFilter filter2) {
        ...
        return new UnboundRecordFilter() {
            ...
            public RecordFilter bind(final Iterable<ColumnReader> readers) {
                return new OrRecordFilter(filter1.bind(readers), filter2.bind(readers), null);
            }
        };
    }
    
    private OrRecordFilter(final RecordFilter boundFilter1, final RecordFilter boundFilter2) {
