...
public class LongArrays
{
    ...
    public static long[] trim(final long[] array, final int length) {
        ...
        final long[] t = (length == 0) ? LongArrays.EMPTY_ARRAY : new long[length];
    ...
    public static long[] copy(final long[] array, final int offset, final int length) {
        ...
        final long[] a = (length == 0) ? LongArrays.EMPTY_ARRAY : new long[length];
    ...
    private static int med3(final long[] x, final int a, final int b, final int c, final LongComparator comp) {
    ...
    public static void mergeSort(final long[] a, final int from, final int to, final LongComparator comp, final long[] supp) {
        final int len = to - from;
        if (len < 7) {
    ...
    public static void mergeSort(final long[] a, final int from, final int to, final LongComparator comp) {
        mergeSort(a, from, to, comp, a.clone());
    }
    
    public static void mergeSort(final long[] a, final LongComparator comp) {
    ...
    public static void radixSort(final long[] a, final int from, final int to) {
        ...
        while (offsetPos > 0) {
            ...
            if (length < 50) {
                ...
                int i = length;
                while (i-- != 0) {
                    digit[i] = (byte)((a[first + i] >>> shift & 0xFFL) ^ (long)signMask);
                }
                i = length;
                while (i-- != 0) {
    ...
    public static void radixSortIndirect(final int[] perm, final long[] a, final int from, final int to, final boolean stable) {
        ...
        while (offsetPos > 0) {
            ...
            if (length < 50) {
                ...
                int i = length;
                while (i-- != 0) {
                    digit[i] = (byte)((a[perm[first + i]] >>> shift & 0xFFL) ^ (long)signMask);
                }
                i = length;
                while (i-- != 0) {
                    final int[] array = count;
    ...
    public static void radixSort(final long[] a, final long[] b, final int from, final int to) {
        ...
        while (offsetPos > 0) {
            ...
            if (length < 50) {
                ...
                int i = length;
                while (i-- != 0) {
                    digit[i] = (byte)((k[first + i] >>> shift & 0xFFL) ^ (long)signMask);
                }
                i = length;
                while (i-- != 0) {
                    final int[] array = count;
    ...
    public static void radixSortIndirect(final int[] perm, final long[] a, final long[] b, final int from, final int to, final boolean stable) {
        ...
        while (offsetPos > 0) {
            ...
            if (length < 50) {
                ...
                int i = length;
                while (i-- != 0) {
                    digit[i] = (byte)((k[perm[first + i]] >>> shift & 0xFFL) ^ (long)signMask);
                }
                i = length;
                while (i-- != 0) {
                    final int[] array = count;
