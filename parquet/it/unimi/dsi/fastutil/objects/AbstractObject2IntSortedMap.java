...
public abstract class AbstractObject2IntSortedMap<K> extends AbstractObject2IntMap<K> implements Object2IntSortedMap<K>
{
    ...
    protected class KeySet extends AbstractObjectSortedSet<K>
    {
        ...
        public ObjectBidirectionalIterator<K> iterator(final K from) {
            return new KeySetIterator<K>((ObjectBidirectionalIterator<Map.Entry<K, Integer>>)AbstractObject2IntSortedMap.this.entrySet().iterator((Map.Entry<K, Integer>)new BasicEntry<Object>((K)from, 0)));
        }
