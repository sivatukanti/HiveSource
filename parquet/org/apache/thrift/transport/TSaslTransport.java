...
import parquet.org.apache.thrift.EncodingUtils;
...
abstract class TSaslTransport extends TTransport
{
    ...
    protected SaslResponse receiveSaslMessage() throws TTransportException {
        ...
        final byte[] payload = new byte[EncodingUtils.decodeBigEndian(this.messageHeader, 1)];
        ...
        Label_0152: {
            if (status == null) {
                this.sendAndThrowMessage(NegotiationStatus.ERROR, "Invalid status " + statusByte);
            }
            else {
    ...
    protected void sendAndThrowMessage(final NegotiationStatus status, String message) throws TTransportException {
        try {
    ...
    public void open() throws TTransportException {
        ...
        try {
            ...
            try {
                this.sendAndThrowMessage(NegotiationStatus.BAD, e.getMessage());
            }
            finally {
