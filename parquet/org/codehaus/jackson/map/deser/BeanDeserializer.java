...
import parquet.org.codehaus.jackson.map.deser.impl.PropertyValueBuffer;
...
import parquet.org.codehaus.jackson.map.introspect.AnnotatedWithParams;
...
import parquet.org.codehaus.jackson.map.deser.impl.CreatorCollector;
import parquet.org.codehaus.jackson.map.deser.impl.ExternalTypeHandler;
import parquet.org.codehaus.jackson.map.deser.impl.UnwrappedPropertyHandler;
import parquet.org.codehaus.jackson.map.type.ClassKey;
import java.util.HashMap;
import java.util.Map;
import java.util.HashSet;
import parquet.org.codehaus.jackson.map.deser.impl.ValueInjector;
import parquet.org.codehaus.jackson.map.deser.impl.BeanPropertyMap;
import parquet.org.codehaus.jackson.map.deser.impl.PropertyBasedCreator;
...
public class BeanDeserializer extends StdDeserializer<Object> implements ResolvableDeserializer
{
    ...
    protected SettableBeanProperty _resolveManagedReferenceProperty(final DeserializationConfig config, final SettableBeanProperty prop) {
        ...
        if (valueDeser instanceof BeanDeserializer) {
            ...
            final JsonDeserializer<?> contentDeser = (JsonDeserializer<?>)((ContainerDeserializerBase)valueDeser).getContentDeserializer();
