...
import parquet.org.codehaus.jackson.map.deser.std.PrimitiveArrayDeserializers;
...
import parquet.org.codehaus.jackson.map.deser.std.StdKeyDeserializers;
import parquet.org.codehaus.jackson.map.util.EnumResolver;
import parquet.org.codehaus.jackson.JsonLocation;
import parquet.org.codehaus.jackson.map.ContextualDeserializer;
...
import parquet.org.codehaus.jackson.map.deser.std.AtomicReferenceDeserializer;
import parquet.org.codehaus.jackson.map.type.TypeFactory;
import java.util.concurrent.atomic.AtomicReference;
import parquet.org.codehaus.jackson.map.deser.std.JsonNodeDeserializer;
import java.util.Iterator;
import parquet.org.codehaus.jackson.map.deser.std.EnumDeserializer;
import parquet.org.codehaus.jackson.map.introspect.AnnotatedMethod;
import parquet.org.codehaus.jackson.map.deser.std.EnumMapDeserializer;
import parquet.org.codehaus.jackson.map.deser.std.MapDeserializer;
import java.util.EnumMap;
import parquet.org.codehaus.jackson.map.deser.std.CollectionDeserializer;
import parquet.org.codehaus.jackson.map.deser.std.StringCollectionDeserializer;
import parquet.org.codehaus.jackson.map.deser.std.EnumSetDeserializer;
...
import parquet.org.codehaus.jackson.map.DeserializerFactory;
