...
import parquet.org.codehaus.jackson.map.deser.std.JavaTypeDeserializer;
import parquet.org.codehaus.jackson.map.deser.std.TokenBufferDeserializer;
import parquet.org.codehaus.jackson.map.deser.std.AtomicBooleanDeserializer;
import parquet.org.codehaus.jackson.map.deser.std.FromStringDeserializer;
import parquet.org.codehaus.jackson.map.deser.std.TimestampDeserializer;
import java.util.Calendar;
import java.util.GregorianCalendar;
import parquet.org.codehaus.jackson.map.deser.std.DateDeserializer;
...
import parquet.org.codehaus.jackson.map.deser.std.StringDeserializer;
import parquet.org.codehaus.jackson.map.deser.std.StdDeserializer;
import parquet.org.codehaus.jackson.map.deser.std.UntypedObjectDeserializer;
