...
import parquet.org.codehaus.jackson.map.ser.impl.UnknownSerializer;
import parquet.org.codehaus.jackson.map.ser.std.StdKeySerializer;
import parquet.org.codehaus.jackson.map.ser.impl.FailingSerializer;
...
import parquet.org.codehaus.jackson.map.ser.std.StdKeySerializers;
...
import parquet.org.codehaus.jackson.map.ser.impl.ReadOnlyClassToSerializerMap;
import parquet.org.codehaus.jackson.map.util.RootNameLookup;
import parquet.org.codehaus.jackson.map.ser.impl.SerializerCache;
...
public class StdSerializerProvider extends SerializerProvider
{
    ...
    public JsonSerializer<Object> findKeySerializer(final JavaType keyType, final BeanProperty property) throws JsonMappingException {
        ...
        if (ser instanceof ContextualSerializer) {
            final ContextualSerializer<?> contextual = (ContextualSerializer<?>)(ContextualSerializer)ser;
