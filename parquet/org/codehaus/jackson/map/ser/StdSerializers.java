...
import parquet.org.codehaus.jackson.map.ser.std.ScalarSerializerBase;
...
import parquet.org.codehaus.jackson.map.ser.std.NonTypedScalarSerializerBase;
...
public class StdSerializers
{
    ...
    @JacksonStdImpl
    @Deprecated
    public static final class CalendarSerializer extends parquet.org.codehaus.jackson.map.ser.std.CalendarSerializer
    {
    }
    ...
    @Deprecated
    @JacksonStdImpl
    public static final class SerializableSerializer extends parquet.org.codehaus.jackson.map.ser.std.SerializableSerializer
    {
    }
    
    @Deprecated
    @JacksonStdImpl
    public static final class SerializableWithTypeSerializer extends parquet.org.codehaus.jackson.map.ser.std.SerializableWithTypeSerializer
    {
    }
}
