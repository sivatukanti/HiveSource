...
import parquet.org.codehaus.jackson.map.ser.BeanPropertyFilter;
...
import parquet.org.codehaus.jackson.map.ser.AnyGetterWriter;
import parquet.org.codehaus.jackson.map.ser.BeanPropertyWriter;
            ...
            if (!prop.hasSerializer()) {
                ...
                if (type.isContainerType()) {
                    ...
                    if (typeSer != null && ser instanceof ContainerSerializerBase) {
                        final JsonSerializer<Object> ser2 = ser = (JsonSerializer<Object>)((ContainerSerializerBase)ser).withValueTypeSerializer(typeSer);
                    }
                }
