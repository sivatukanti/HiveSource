...
public class OptionalHandlerFactory
{
    ...
    private static final String SERIALIZERS_FOR_JODA_DATETIME = "parquet.org.codehaus.jackson.map.ext.JodaSerializers";
    private static final String SERIALIZERS_FOR_JAVAX_XML = "parquet.org.codehaus.jackson.map.ext.CoreXMLSerializers";
    private static final String DESERIALIZERS_FOR_JODA_DATETIME = "parquet.org.codehaus.jackson.map.ext.JodaDeserializers";
    private static final String DESERIALIZERS_FOR_JAVAX_XML = "parquet.org.codehaus.jackson.map.ext.CoreXMLDeserializers";
    ...
    private static final String SERIALIZER_FOR_DOM_NODE = "parquet.org.codehaus.jackson.map.ext.DOMSerializer";
    private static final String DESERIALIZER_FOR_DOM_DOCUMENT = "parquet.org.codehaus.jackson.map.ext.DOMDeserializer$DocumentDeserializer";
    private static final String DESERIALIZER_FOR_DOM_NODE = "parquet.org.codehaus.jackson.map.ext.DOMDeserializer$NodeDeserializer";
    ...
    public JsonSerializer<?> findSerializer(final SerializationConfig config, final JavaType type) {
        ...
        if (className.startsWith("org.joda.time.")) {
            factoryName = "parquet.org.codehaus.jackson.map.ext.JodaSerializers";
        }
        else if (className.startsWith("javax.xml.") || this.hasSupertypeStartingWith(rawType, "javax.xml.")) {
            factoryName = "parquet.org.codehaus.jackson.map.ext.CoreXMLSerializers";
        }
        else {
            if (this.doesImplement(rawType, "org.w3c.dom.Node")) {
                return (JsonSerializer<?>)this.instantiate("parquet.org.codehaus.jackson.map.ext.DOMSerializer");
            }
            return null;
        }
    ...
    public JsonDeserializer<?> findDeserializer(final JavaType type, final DeserializationConfig config, final DeserializerProvider p) {
        ...
        String factoryName;
        if (className.startsWith("org.joda.time.")) {
            factoryName = "parquet.org.codehaus.jackson.map.ext.JodaDeserializers";
        }
        else if (className.startsWith("javax.xml.") || this.hasSupertypeStartingWith(rawType, "javax.xml.")) {
            factoryName = "parquet.org.codehaus.jackson.map.ext.CoreXMLDeserializers";
        }
        else {
            if (this.doesImplement(rawType, "org.w3c.dom.Node")) {
                return (JsonDeserializer<?>)this.instantiate("parquet.org.codehaus.jackson.map.ext.DOMDeserializer$DocumentDeserializer");
            }
            if (this.doesImplement(rawType, "org.w3c.dom.Node")) {
                return (JsonDeserializer<?>)this.instantiate("parquet.org.codehaus.jackson.map.ext.DOMDeserializer$NodeDeserializer");
            }
            return null;
        }
        final Object ob = this.instantiate(factoryName);
