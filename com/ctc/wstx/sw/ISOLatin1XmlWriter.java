...
{
    public ISOLatin1XmlWriter(final OutputStream out, final WriterConfig cfg, final boolean autoclose) throws IOException {
    ...
    protected void handleInvalidLatinChar(final int c) throws IOException {
        this.flush();
