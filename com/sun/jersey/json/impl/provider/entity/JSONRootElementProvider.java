...
public class JSONRootElementProvider extends AbstractRootElementProvider
{
    ...
    protected void consumeFeaturesAndProperties(final FeaturesAndProperties fp) {
    ...
    protected void writeTo(final Object t, final MediaType mediaType, final Charset c, final Marshaller m, final OutputStream entityStream) throws JAXBException {
        final JSONMarshaller jsonMarshaller = JSONJAXBContext.getJSONMarshaller(m, this.getJAXBContext(t.getClass()));
    ...
    @Produces({ "application/vnd.sun.wadl+json" })
    @Consumes({ "application/vnd.sun.wadl+json" })
    public static final class Wadl extends JSONRootElementProvider
    {
        public Wadl(@Context final Providers ps) {
