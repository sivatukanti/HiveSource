...
public interface WinCrypt
{
    ...
    public static class CTL_ENTRY extends Structure
    {
        ...
        public CRYPT_ATTRIBUTE[] getRgAttribute() {
            ...
            return (CRYPT_ATTRIBUTE[])Structure.newInstance(CERT_EXTENSION.class, this.rgAttribute).toArray(this.cAttribute);
        }
    ...
    public static class CTL_INFO extends Structure
    {
        ...
        public CTL_ENTRY[] getRgExtension() {
            ...
            return (CTL_ENTRY[])Structure.newInstance(CTL_ENTRY.class, this.rgCTLEntry).toArray(this.cCTLEntry);
        }
        ...
        public CERT_EXTENSION[] getRgCTLEntry() {
            ...
            return (CERT_EXTENSION[])Structure.newInstance(CERT_EXTENSION.class, this.rgExtension).toArray(this.cExtension);
        }
    ...
    public static class CERT_EXTENSIONS extends Structure
    {
        ...
        public CERT_EXTENSION[] getRgExtension() {
            final CERT_EXTENSION[] elements = new CERT_EXTENSION[this.cExtension];
            for (int i = 0; i < elements.length; ++i) {
                (elements[i] = Structure.newInstance(CERT_EXTENSION.class, this.rgExtension.getPointer(i * Native.POINTER_SIZE))).read();
            }
            return elements;
        }
    ...
    public static class CRL_INFO extends Structure
    {
        ...
        public CRL_ENTRY[] getRgCRLEntry() {
            final CRL_ENTRY[] elements = new CRL_ENTRY[this.cCRLEntry];
            for (int i = 0; i < elements.length; ++i) {
                (elements[i] = Structure.newInstance(CRL_ENTRY.class, this.rgCRLEntry.getPointer(i * Native.POINTER_SIZE))).read();
            }
            return elements;
        }
