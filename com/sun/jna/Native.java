...
public final class Native implements Version
{
    ...
    public static void main(final String[] args) {
        ...
        final String DEFAULT_VERSION = "5.3.1";
        final String DEFAULT_BUILD = "5.3.1 (package information missing)";
        ...
        String version = (pkg != null) ? pkg.getSpecificationVersion() : "5.3.1";
        if (version == null) {
            version = "5.3.1";
        }
        title = title + " API Version " + version;
        System.out.println(title);
        version = ((pkg != null) ? pkg.getImplementationVersion() : "5.3.1 (package information missing)");
        if (version == null) {
            version = "5.3.1 (package information missing)";
        }
    ...
    static {
        ...
        DEFAULT_ENCODING = Native.DEFAULT_CHARSET.name();
        ...
        MAX_ALIGNMENT = ((Platform.isSPARC() || Platform.isWindows() || (Platform.isLinux() && (Platform.isARM() || Platform.isPPC() || Platform.isMIPS())) || Platform.isAIX() || (Platform.isAndroid() && !Platform.isIntel())) ? 8 : Native.LONG_SIZE);
