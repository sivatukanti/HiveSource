...
public class WebSocketClientHandshaker08 extends WebSocketClientHandshaker
{
    ...
    public WebSocketClientHandshaker08(final URI webSocketURL, final WebSocketVersion version, final String subprotocol, final boolean allowExtensions, final Map<String, String> customHeaders) {
        this(webSocketURL, version, subprotocol, allowExtensions, customHeaders, Long.MAX_VALUE);
    }
    
    public WebSocketClientHandshaker08(final URI webSocketURL, final WebSocketVersion version, final String subprotocol, final boolean allowExtensions, final Map<String, String> customHeaders, final long maxFramePayloadLength) {
    ...
    public ChannelFuture handshake(final Channel channel) throws Exception {
        ...
        if (WebSocketClientHandshaker08.logger.isDebugEnabled()) {
            WebSocketClientHandshaker08.logger.debug(String.format("WS Version 08 Client Handshake key: %s. Expected response: %s.", key, this.expectedChallengeResponseString));
        }
    ...
    public void finishHandshake(final Channel channel, final HttpResponse response) {
        ...
        WebSocketClientHandshaker.replaceDecoder(channel, new WebSocket08FrameDecoder(false, this.allowExtensions, this.getMaxFramePayloadLength()));
    }
