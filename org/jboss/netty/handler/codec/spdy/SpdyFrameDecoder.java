        ...
        while (true) {
            switch (this.state) {
                ...
                case READ_DATA_FRAME: {
                    if (this.length == 0) {
                        this.state = State.READ_COMMON_HEADER;
                        this.delegate.readDataFrame(this.streamId, hasFlag(this.flags, (byte)1), ChannelBuffers.EMPTY_BUFFER);
                        continue;
                    }
                    ...
                    final ChannelBuffer data = buffer.readBytes(dataLength);
                ...
                case READ_HEADER_BLOCK: {
                    ...
                    final ChannelBuffer headerBlock = buffer.readBytes(compressedBytes);
