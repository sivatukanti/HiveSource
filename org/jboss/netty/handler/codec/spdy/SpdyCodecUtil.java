...
final class SpdyCodecUtil
{
    ...
    static int getUnsignedShort(final ChannelBuffer buf, final int offset) {
        return (buf.getByte(offset) & 0xFF) << 8 | (buf.getByte(offset + 1) & 0xFF);
    }
    
    static int getUnsignedMedium(final ChannelBuffer buf, final int offset) {
        return (buf.getByte(offset) & 0xFF) << 16 | (buf.getByte(offset + 1) & 0xFF) << 8 | (buf.getByte(offset + 2) & 0xFF);
    }
    
    static int getUnsignedInt(final ChannelBuffer buf, final int offset) {
        return (buf.getByte(offset) & 0x7F) << 24 | (buf.getByte(offset + 1) & 0xFF) << 16 | (buf.getByte(offset + 2) & 0xFF) << 8 | (buf.getByte(offset + 3) & 0xFF);
    }
    
    static int getSignedInt(final ChannelBuffer buf, final int offset) {
