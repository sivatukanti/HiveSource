...
public final class OpenSslServerContext extends SslContext
{
    ...
    public OpenSslServerContext(final SslBufferPool bufPool, final File certChainFile, final File keyFile, String keyPassword, Iterable<String> ciphers, Iterable<String> nextProtocols, long sessionCacheSize, long sessionTimeout) throws SSLException {
        super(bufPool);
    ...
    @Override
    public SSLEngine newEngine(final String peerHost, final int peerPort) {
