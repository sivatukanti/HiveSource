...
public final class JdkSslClientContext extends JdkSslContext
{
    ...
    public JdkSslClientContext(final File certChainFile, final TrustManagerFactory trustManagerFactory) throws SSLException {
        this(null, certChainFile, trustManagerFactory, null, null, 0L, 0L);
    }
    
    public JdkSslClientContext(final SslBufferPool bufPool, final File certChainFile, TrustManagerFactory trustManagerFactory, final Iterable<String> ciphers, final Iterable<String> nextProtocols, final long sessionCacheSize, final long sessionTimeout) throws SSLException {
        ...
        try {
            if (certChainFile == null) {
                ...
                for (final ChannelBuffer buf : PemReader.readCertificates(certChainFile)) {
                    final X509Certificate cert = (X509Certificate)cf.generateCertificate(new ChannelBufferInputStream(buf));
