...
public final class OpenSslEngine extends SSLEngine
{
    ...
    public OpenSslEngine(final long sslCtx, final SslBufferPool bufPool, final String fallbackApplicationProtocol) {
    ...
    private int writePlaintextData(final ByteBuffer src) {
        ...
        if (src.isDirect()) {
            ...
            final ByteBuffer buf = this.bufPool.acquireBuffer();
            try {
                assert buf.isDirect();
