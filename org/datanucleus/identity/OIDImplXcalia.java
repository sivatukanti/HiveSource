...
public class OIDImplXcalia implements Serializable, OID, Comparable
{
    ...
    public OIDImplXcalia(final String pcClass, final Object object) {
    ...
    public OIDImplXcalia(final String str) throws IllegalArgumentException {
        if (str.length() < 2) {
            throw new IllegalArgumentException(OIDImplXcalia.LOCALISER.msg("038000", str));
        }
    ...
    public boolean equals(final Object obj) {
        return obj != null && (obj == this || (obj.getClass().getName().equals(OIDImplXcalia.class.getName()) && this.hashCode() == obj.hashCode() && ((OID)obj).toString().equals(this.toString)));
    }
    
    @Override
    public int compareTo(final Object o) {
        if (o instanceof OIDImplXcalia) {
            final OIDImplXcalia c = (OIDImplXcalia)o;
