...
{
    public UniqueMetadataImpl(final UniqueMetaData internal) {
        super(internal);
    }
    ...
    public UniqueMetadata setDeferred(final boolean flag) {
        this.getInternal().setDeferred(flag);
        return this;
    }
    
    public UniqueMetadata setName(final String name) {
        this.getInternal().setName(name);
        return this;
    }
    
    public UniqueMetadata setTable(final String name) {
