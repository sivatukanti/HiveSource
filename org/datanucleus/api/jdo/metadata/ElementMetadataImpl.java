...
{
    public ElementMetadataImpl(final ElementMetaData internal) {
        super(internal);
    }
    ...
    public ElementMetadata setColumn(final String name) {
    ...
    public ElementMetadata setDeleteAction(final ForeignKeyAction fk) {
    ...
    public ElementMetadata setUpdateAction(final ForeignKeyAction fk) {
        if (fk == ForeignKeyAction.CASCADE) {
    ...
    public ElementMetadata setTable(final String name) {
        return null;
    }
}
