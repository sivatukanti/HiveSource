...
{
    public ValueMetadataImpl(final ValueMetaData internal) {
        super(internal);
    }
    ...
    public ValueMetadata setColumn(final String name) {
    ...
    public ValueMetadata setDeleteAction(final ForeignKeyAction fk) {
    ...
    public ValueMetadata setUpdateAction(final ForeignKeyAction fk) {
        if (fk == ForeignKeyAction.CASCADE) {
    ...
    public ValueMetadata setTable(final String name) {
        return null;
    }
}
