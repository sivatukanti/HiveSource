...
public class StringTranslateMethod extends AbstractSQLMethod
{
    ...
    public SQLExpression getExpression(final SQLExpression expr, final List args) {
        if (args == null || args.size() != 2) {
            throw new NucleusException(StringTranslateMethod.LOCALISER.msg("060003", "translate", "StringExpression", 2, "StringExpression/CharacterExpression"));
        }
        ...
        if (!(strExpr1 instanceof StringExpression) && !(strExpr1 instanceof CharacterExpression)) {
            throw new NucleusException(StringTranslateMethod.LOCALISER.msg("060003", "translate", "StringExpression", 1, "StringExpression/CharacterExpression"));
        }
