...
public class MathTanMethod extends AbstractSQLMethod
{
    ...
    public SQLExpression getExpression(final SQLExpression ignore, final List args) {
        ...
        if (expr instanceof ByteLiteral) {
            ...
            final BigInteger absValue = new BigInteger(String.valueOf(Math.tan(originalValue)));
        ...
        if (expr instanceof IntegerLiteral) {
            ...
            final Double absValue2 = new Double(Math.tan(originalValue));
        ...
        if (expr instanceof FloatingPointLiteral) {
            ...
            final Double absValue3 = new Double(Math.tan(originalValue2));
