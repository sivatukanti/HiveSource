...
public class DateGetHour2Method extends AbstractSQLMethod
{
    ...
    public SQLExpression getExpression(final SQLExpression expr, final List args) {
        if (!(expr instanceof TemporalExpression)) {
            throw new NucleusException(DateGetHour2Method.LOCALISER.msg("060001", "getHour", expr));
        }
        ...
        final SQLExpression hh = this.exprFactory.newLiteral(this.stmt, mapping, "HH24");
