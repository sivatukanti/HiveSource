...
public class DateGetMinute3Method extends AbstractSQLMethod
{
    ...
    public SQLExpression getExpression(final SQLExpression expr, final List args) {
        if (!(expr instanceof TemporalExpression)) {
            throw new NucleusException(DateGetMinute3Method.LOCALISER.msg("060001", "getMinute()", expr));
        }
        ...
        final SQLExpression day = this.exprFactory.newLiteral(this.stmt, mapping, "minute");
