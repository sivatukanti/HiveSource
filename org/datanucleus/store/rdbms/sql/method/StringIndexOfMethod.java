...
public class StringIndexOfMethod extends AbstractSQLMethod
{
    ...
    public SQLExpression getExpression(final SQLExpression expr, final List args) {
        if (args == null || args.size() == 0 || args.size() > 2) {
            throw new NucleusException(StringIndexOfMethod.LOCALISER.msg("060003", "indexOf", "StringExpression", 0, "StringExpression/CharacterExpression/ParameterLiteral"));
        }
        ...
        if (args.size() == 2) {
            ...
            if (!(fromExpr instanceof NumericExpression)) {
                throw new NucleusException(StringIndexOfMethod.LOCALISER.msg("060003", "indexOf", "StringExpression", 1, "NumericExpression"));
            }
