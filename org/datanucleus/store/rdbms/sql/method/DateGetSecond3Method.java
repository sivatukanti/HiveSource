...
public class DateGetSecond3Method extends AbstractSQLMethod
{
    ...
    public SQLExpression getExpression(final SQLExpression expr, final List args) {
        if (!(expr instanceof TemporalExpression)) {
            throw new NucleusException(DateGetSecond3Method.LOCALISER.msg("060001", "getSecond()", expr));
        }
        ...
        final SQLExpression day = this.exprFactory.newLiteral(this.stmt, mapping, "second");
