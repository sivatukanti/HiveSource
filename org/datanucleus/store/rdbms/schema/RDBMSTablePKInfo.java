...
public class RDBMSTablePKInfo implements ListStoreSchemaData
{
    ...
    public RDBMSTablePKInfo(final String catalog, final String schema, final String table) {
        this.hash = 0;
        this.properties = new HashMap();
        this.pks = new ArrayList();
    ...
    public final boolean equals(final Object obj) {
        ...
        final RDBMSTablePKInfo other = (RDBMSTablePKInfo)obj;
    ...
    public String toString() {
        final StringBuffer str = new StringBuffer("RDBMSTablePKInfo : ");
