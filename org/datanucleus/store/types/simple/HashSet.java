...
public class HashSet extends java.util.HashSet implements SCOCollection, SCOMtoN, Cloneable
{
    ...
    public HashSet(final ObjectProvider ownerOP, final AbstractMemberMetaData mmd) {
        super(0);
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        ...
        if (c != null) {
            this.delegate = (java.util.HashSet)c;
        }
        else {
            this.delegate = new java.util.HashSet();
        }
        if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
            NucleusLogger.PERSISTENCE.debug(HashSet.LOCALISER.msg("023003", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + this.size(), SCOUtils.getSCOWrapperOptionsMessage(true, false, true, false)));
        }
    }
    ...
    public Object detachCopy(final FetchPlanState state) {
        final Collection detached = new java.util.HashSet();
