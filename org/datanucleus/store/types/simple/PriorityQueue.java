...
public class PriorityQueue extends java.util.PriorityQueue implements SCOCollection, SCOMtoN, Cloneable, Serializable
{
    ...
    public PriorityQueue(final ObjectProvider ownerOP, final AbstractMemberMetaData mmd) {
        super(1);
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        ...
        if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
            NucleusLogger.PERSISTENCE.debug(PriorityQueue.LOCALISER.msg("023003", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + this.size(), SCOUtils.getSCOWrapperOptionsMessage(true, false, false, false)));
        }
    }
    ...
    public Object detachCopy(final FetchPlanState state) {
        final Collection detached = new java.util.PriorityQueue();
    ...
    static {
        LOCALISER = Localiser.getInstance("org.datanucleus.Localisation", PriorityQueue.class.getClassLoader());
    }
}
