...
public class Vector extends java.util.Vector implements SCOList, Cloneable
{
    ...
    public Vector(final ObjectProvider ownerOP, final AbstractMemberMetaData mmd) {
        super(0);
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        ...
        if (c != null) {
            this.delegate = (java.util.Vector)c;
        }
        else {
            this.delegate = new java.util.Vector();
        }
        if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
            NucleusLogger.PERSISTENCE.debug(Vector.LOCALISER.msg("023003", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + this.size(), SCOUtils.getSCOWrapperOptionsMessage(true, false, true, false)));
        }
    }
    ...
    public Object detachCopy(final FetchPlanState state) {
        final Collection detached = new java.util.Vector();
    ...
    public void attachCopy(final Object value) {
        ...
        final List attachedElements = new ArrayList(c.size());
    ...
    public synchronized void clear() {
        ...
        if (this.ownerOP != null && !this.delegate.isEmpty() && SCOUtils.hasDependentElement(this.ownerMmd)) {
            final List copy = new ArrayList(this.delegate);
