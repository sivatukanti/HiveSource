...
public class LinkedHashMap extends java.util.LinkedHashMap implements SCOMap, Cloneable
{
    ...
    public LinkedHashMap(final ObjectProvider ownerOP, final AbstractMemberMetaData mmd) {
        super(0);
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        final Map m = (Map)o;
        if (m != null) {
            this.delegate = (java.util.LinkedHashMap)m;
        }
        else {
            this.delegate = new java.util.LinkedHashMap();
        }
        if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
            NucleusLogger.PERSISTENCE.debug(LinkedHashMap.LOCALISER.msg("023003", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + this.size(), SCOUtils.getSCOWrapperOptionsMessage(true, false, true, false)));
        }
    }
    ...
    public Object detachCopy(final FetchPlanState state) {
        final Map detached = new java.util.LinkedHashMap();
    ...
    public void attachCopy(final Object value) {
        ...
        final Map attachedKeysValues = new HashMap(m.size());
