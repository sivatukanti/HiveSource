...
public class LinkedList extends java.util.LinkedList implements SCOList, Cloneable
{
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        ...
        if (c != null) {
            this.delegate = (java.util.LinkedList)c;
        }
        else {
            this.delegate = new java.util.LinkedList();
        }
        if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
            NucleusLogger.PERSISTENCE.debug(LinkedList.LOCALISER.msg("023003", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + this.size(), SCOUtils.getSCOWrapperOptionsMessage(true, false, true, false)));
        }
    }
    ...
    public Object detachCopy(final FetchPlanState state) {
        final Collection detached = new java.util.LinkedList();
    ...
    public Object removeFirst() {
        final Object element = this.delegate.removeFirst();
        if (this.ownerOP != null && SCOUtils.hasDependentElement(this.ownerMmd)) {
            this.ownerOP.getExecutionContext().deleteObjectInternal(element);
        }
        this.makeDirty();
    ...
    public Object removeLast() {
        final Object element = this.delegate.removeLast();
        if (this.ownerOP != null && SCOUtils.hasDependentElement(this.ownerMmd)) {
            this.ownerOP.getExecutionContext().deleteObjectInternal(element);
        }
        this.makeDirty();
