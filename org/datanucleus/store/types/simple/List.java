...
public class List extends AbstractList implements SCOList, Cloneable, Serializable
{
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        ...
        if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
            NucleusLogger.PERSISTENCE.debug(List.LOCALISER.msg("023003", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + this.size(), SCOUtils.getSCOWrapperOptionsMessage(true, false, true, false)));
        }
    }
    ...
    public Object detachCopy(final FetchPlanState state) {
        final Collection detached = new ArrayList();
    ...
    public void attachCopy(final Object value) {
        ...
        final java.util.List attachedElements = new ArrayList(c.size());
    ...
    public synchronized void clear() {
        ...
        if (this.ownerOP != null && !this.delegate.isEmpty() && SCOUtils.hasDependentElement(this.ownerMmd)) {
            final java.util.List copy = new ArrayList(this.delegate);
