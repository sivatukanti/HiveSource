...
public class Hashtable extends java.util.Hashtable implements SCOMap, Cloneable
{
    ...
    public Hashtable(final ObjectProvider ownerOP, final AbstractMemberMetaData mmd) {
        super(0);
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        final Map m = (Map)o;
        if (m != null) {
            this.delegate = (java.util.Hashtable)m;
        }
        else {
            this.delegate = new java.util.Hashtable();
        }
        if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
            NucleusLogger.PERSISTENCE.debug(Hashtable.LOCALISER.msg("023003", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + this.size(), SCOUtils.getSCOWrapperOptionsMessage(true, false, false, false)));
        }
    }
    ...
    public Object detachCopy(final FetchPlanState state) {
        final Map detached = new java.util.Hashtable();
