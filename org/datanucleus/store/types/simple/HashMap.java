...
public class HashMap extends java.util.HashMap implements SCOMap, Cloneable
{
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        final Map m = (Map)o;
        if (m != null) {
            this.delegate = (java.util.HashMap)m;
        }
        else {
            this.delegate = new java.util.HashMap();
        }
        if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
            NucleusLogger.PERSISTENCE.debug(HashMap.LOCALISER.msg("023003", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + this.size(), SCOUtils.getSCOWrapperOptionsMessage(true, false, true, false)));
        }
    }
    ...
    public Object detachCopy(final FetchPlanState state) {
        final Map detached = new java.util.HashMap();
    ...
    public void attachCopy(final Object value) {
        ...
        final Map attachedKeysValues = new java.util.HashMap(m.size());
