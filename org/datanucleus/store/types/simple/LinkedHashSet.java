...
public class LinkedHashSet extends java.util.LinkedHashSet implements SCOCollection, SCOMtoN, Cloneable
{
    ...
    public LinkedHashSet(final ObjectProvider ownerOP, final AbstractMemberMetaData mmd) {
        super(0);
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        ...
        if (c != null) {
            this.delegate = (java.util.LinkedHashSet)c;
        }
        else {
            this.delegate = new java.util.LinkedHashSet();
        }
        if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
            NucleusLogger.PERSISTENCE.debug(LinkedHashSet.LOCALISER.msg("023003", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + this.size(), SCOUtils.getSCOWrapperOptionsMessage(true, false, true, false)));
        }
    }
    ...
    public Object detachCopy(final FetchPlanState state) {
        final Collection detached = new java.util.LinkedHashSet();
