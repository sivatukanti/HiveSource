...
public class Collection extends AbstractCollection implements SCOCollection, SCOMtoN, Cloneable, Serializable
{
    ...
    public Collection(final ObjectProvider ownerOP, final AbstractMemberMetaData mmd) {
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        ...
        if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
            NucleusLogger.PERSISTENCE.debug(Collection.LOCALISER.msg("023003", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + this.size(), SCOUtils.getSCOWrapperOptionsMessage(true, false, true, false)));
        }
    }
    ...
    public Object detachCopy(final FetchPlanState state) {
        final java.util.Collection detached = new HashSet();
    ...
    public void attachCopy(final Object value) {
        final java.util.Collection c = (java.util.Collection)value;
