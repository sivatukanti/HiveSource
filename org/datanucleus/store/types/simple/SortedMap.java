...
public class SortedMap extends AbstractMap implements java.util.SortedMap, SCOMap, Cloneable, Serializable
{
    ...
    public SortedMap(final ObjectProvider ownerOP, final AbstractMemberMetaData mmd) {
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        ...
        if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
            NucleusLogger.PERSISTENCE.debug(SortedMap.LOCALISER.msg("023003", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + this.size(), SCOUtils.getSCOWrapperOptionsMessage(true, false, false, false)));
        }
    }
    ...
    public Object detachCopy(final FetchPlanState state) {
        final Map detached = new TreeMap();
    ...
    public void attachCopy(final Object value) {
        ...
        final Map attachedKeysValues = new TreeMap();
