...
public class SortedSet extends AbstractSet implements java.util.SortedSet, SCOCollection, SCOMtoN, Cloneable, Serializable
{
    ...
    public SortedSet(final ObjectProvider ownerOP, final AbstractMemberMetaData mmd) {
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        ...
        if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
            NucleusLogger.PERSISTENCE.debug(SortedSet.LOCALISER.msg("023003", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + this.size(), SCOUtils.getSCOWrapperOptionsMessage(true, false, true, false)));
        }
    }
    ...
    public Object detachCopy(final FetchPlanState state) {
        ...
        if (comparator != null) {
            detached = new TreeSet(comparator);
        }
        else {
            detached = new TreeSet();
        }
