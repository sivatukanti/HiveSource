...
public class HashSet extends org.datanucleus.store.types.simple.HashSet implements BackedSCO
{
    ...
    public HashSet(final ObjectProvider op, final AbstractMemberMetaData mmd) {
        super(op, mmd);
        ...
        if (!SCOUtils.collectionHasSerialisedElements(mmd) && mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT) {
            ...
            this.backingStore = (SetStore)((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.HashSet.class);
        }
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        ...
        if (c != null) {
            ...
            if (forInsert) {
                if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
                    NucleusLogger.PERSISTENCE.debug(HashSet.LOCALISER.msg("023007", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + c.size()));
                }
                if (this.useCache) {
                    this.loadFromStore();
                }
                ...
                if (this.backingStore != null) {
                    if (SCOUtils.useQueuedUpdate(this.queued, this.ownerOP)) {
                        ...
                        try {
                            ...
                            NucleusLogger.PERSISTENCE.warn(HashSet.LOCALISER.msg("023013", "addAll", this.ownerMmd.getName(), dse));
                        }
                    }
                }
                this.makeDirty();
                ...
                if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
                    NucleusLogger.PERSISTENCE.debug(HashSet.LOCALISER.msg("023008", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + c.size()));
                }
                if (this.useCache) {
                    this.isCacheLoaded = false;
                    this.loadFromStore();
                    ...
                    final java.util.HashSet delegateCopy = new java.util.HashSet(this.delegate);
    ...
    protected void loadFromStore() {
        if (this.backingStore != null && !this.isCacheLoaded) {
            if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
                NucleusLogger.PERSISTENCE.debug(HashSet.LOCALISER.msg("023006", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName()));
            }
            this.delegate.clear();
    ...
    public synchronized boolean containsAll(final Collection c) {
        if (this.useCache) {
            ...
            final java.util.HashSet h = new java.util.HashSet(c);
        ...
        if (this.backingStore != null) {
            if (SCOUtils.useQueuedUpdate(this.queued, this.ownerOP)) {
                ...
                try {
                    ...
                    NucleusLogger.PERSISTENCE.warn(HashSet.LOCALISER.msg("023013", "add", this.ownerMmd.getName(), dse));
        ...
        if (this.backingStore != null) {
            if (SCOUtils.useQueuedUpdate(this.queued, this.ownerOP)) {
                ...
                try {
                    ...
                    NucleusLogger.PERSISTENCE.warn(HashSet.LOCALISER.msg("023013", "remove", this.ownerMmd.getName(), dse));
                    backingSuccess = false;
                }
            }
        }
        ...
        if (this.backingStore != null) {
            ...
            if (SCOUtils.useQueuedUpdate(this.queued, this.ownerOP)) {
                ...
                try {
                    ...
                    NucleusLogger.PERSISTENCE.warn(HashSet.LOCALISER.msg("023013", "removeAll", this.ownerMmd.getName(), dse));
                    backingSuccess = false;
                }
            }
            if (this.ownerOP != null && !this.ownerOP.getExecutionContext().getTransaction().isActive()) {
