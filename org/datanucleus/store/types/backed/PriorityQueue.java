...
public class PriorityQueue extends org.datanucleus.store.types.simple.PriorityQueue implements BackedSCO
{
    ...
    public PriorityQueue(final ObjectProvider op, final AbstractMemberMetaData mmd) {
        super(op, mmd);
        ...
        if (!SCOUtils.collectionHasSerialisedElements(mmd) && mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT) {
            ...
            this.backingStore = (ListStore)((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.PriorityQueue.class);
        }
        ...
        if (mmd.getCollection().hasExtension("comparatorName")) {
            ...
            try {
                ...
                NucleusLogger.PERSISTENCE.warn(PriorityQueue.LOCALISER.msg("023012", mmd.getFullFieldName(), comparatorName));
            }
        }
        if (comparator != null) {
    ...
    public void initialise(final Object o, final boolean forInsert, final boolean forUpdate) {
        ...
        if (c != null) {
            ...
            if (forInsert) {
                if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
                    NucleusLogger.PERSISTENCE.debug(PriorityQueue.LOCALISER.msg("023007", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + c.size()));
                }
                if (this.useCache) {
                    this.loadFromStore();
                }
                if (this.backingStore != null) {
                    if (SCOUtils.useQueuedUpdate(this.queued, this.ownerOP)) {
                        ...
                        try {
                            ...
                            NucleusLogger.PERSISTENCE.warn(PriorityQueue.LOCALISER.msg("023013", "addAll", this.ownerMmd.getName(), dse));
                        }
                    }
                }
                this.makeDirty();
                ...
                if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
                    NucleusLogger.PERSISTENCE.debug(PriorityQueue.LOCALISER.msg("023008", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName(), "" + c.size()));
                }
                if (this.backingStore != null) {
                    if (SCOUtils.useQueuedUpdate(this.queued, this.ownerOP)) {
    ...
    protected void loadFromStore() {
        if (this.backingStore != null && !this.isCacheLoaded) {
            if (NucleusLogger.PERSISTENCE.isDebugEnabled()) {
                NucleusLogger.PERSISTENCE.debug(PriorityQueue.LOCALISER.msg("023006", this.ownerOP.getObjectAsPrintable(), this.ownerMmd.getName()));
            }
            this.delegate.clear();
    ...
    public synchronized boolean equals(final Object o) {
        ...
        final java.util.PriorityQueue c = (java.util.PriorityQueue)o;
        ...
        if (this.backingStore != null) {
            if (SCOUtils.useQueuedUpdate(this.queued, this.ownerOP)) {
                ...
                try {
                    ...
                    NucleusLogger.PERSISTENCE.warn(PriorityQueue.LOCALISER.msg("023013", "add", this.ownerMmd.getName(), dse));
        ...
        if (this.backingStore != null) {
            if (SCOUtils.useQueuedUpdate(this.queued, this.ownerOP)) {
                ...
                try {
                    ...
                    NucleusLogger.PERSISTENCE.warn(PriorityQueue.LOCALISER.msg("023013", "remove", this.ownerMmd.getName(), dse));
                    backingSuccess = false;
                }
            }
        }
        ...
        if (this.backingStore != null) {
            ...
            if (SCOUtils.useQueuedUpdate(this.queued, this.ownerOP)) {
                ...
                try {
                    ...
                    NucleusLogger.PERSISTENCE.warn(PriorityQueue.LOCALISER.msg("023013", "removeAll", this.ownerMmd.getName(), dse));
                    backingSuccess = false;
                }
            }
            if (this.ownerOP != null && !this.ownerOP.getExecutionContext().getTransaction().isActive()) {
