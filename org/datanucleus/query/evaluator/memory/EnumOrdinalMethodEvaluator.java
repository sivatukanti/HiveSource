...
public class EnumOrdinalMethodEvaluator implements InvocationEvaluator
{
    ...
    public Object evaluate(final InvokeExpression expr, final Object invokedValue, final InMemoryExpressionEvaluator eval) {
        ...
        if (!(invokedValue instanceof Enum)) {
            throw new NucleusException(EnumOrdinalMethodEvaluator.LOCALISER.msg("021011", method, invokedValue.getClass().getName()));
        }
