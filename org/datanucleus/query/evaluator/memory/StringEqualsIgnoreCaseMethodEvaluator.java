...
public class StringEqualsIgnoreCaseMethodEvaluator implements InvocationEvaluator
{
    ...
    public Object evaluate(final InvokeExpression expr, final Object invokedValue, final InMemoryExpressionEvaluator eval) {
        ...
        if (!(invokedValue instanceof String)) {
            throw new NucleusException(StringEqualsIgnoreCaseMethodEvaluator.LOCALISER.msg("021011", method, invokedValue.getClass().getName()));
        }
        String arg1 = null;
        Object argObj = null;
