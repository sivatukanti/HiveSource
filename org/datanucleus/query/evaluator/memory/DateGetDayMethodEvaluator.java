...
public class DateGetDayMethodEvaluator implements InvocationEvaluator
{
    ...
    public Object evaluate(final InvokeExpression expr, final Object invokedValue, final InMemoryExpressionEvaluator eval) {
        ...
        if (!(invokedValue instanceof Date)) {
            throw new NucleusException(DateGetDayMethodEvaluator.LOCALISER.msg("021011", method, invokedValue.getClass().getName()));
        }
