...
public class LowerFunctionEvaluator implements InvocationEvaluator
{
    ...
    public Object evaluate(final InvokeExpression expr, final Object invokedValue, final InMemoryExpressionEvaluator eval) {
        ...
        if (!(paramValue instanceof String)) {
            throw new NucleusException(LowerFunctionEvaluator.LOCALISER.msg("021011", method, paramValue.getClass().getName()));
        }
