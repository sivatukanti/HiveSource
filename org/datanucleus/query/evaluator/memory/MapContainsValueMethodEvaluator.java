...
public class MapContainsValueMethodEvaluator implements InvocationEvaluator
{
    ...
    public Object evaluate(final InvokeExpression expr, final Object invokedValue, final InMemoryExpressionEvaluator eval) {
        ...
        if (!(invokedValue instanceof Map)) {
            throw new NucleusException(MapContainsValueMethodEvaluator.LOCALISER.msg("021011", method, invokedValue.getClass().getName()));
        }
