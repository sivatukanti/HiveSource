...
public class JdoGetViaMediate extends ClassMethod
{
    ...
    public JdoGetViaMediate(final ClassEnhancer enhancer, final AbstractMemberMetaData fmd) {
    ...
    public void execute() {
        ...
        if (this.enhancer.getClassMetaData().isDetachable()) {
            ...
            if (this.enhancer.hasOption("generate-detach-listener")) {
                ...
                this.visitor.visitLdcInsn(JdoGetViaMediate.LOCALISER.msg("Enhancer.DetachedFieldAccess", this.fmd.getName()));
