...
{
    public static JdoGetObjectId getInstance(final ClassEnhancer enhancer) {
        return new JdoGetObjectId(enhancer, enhancer.getNamer().getGetObjectIdMethodName(), 17, Object.class, null, null);
    }
    
    public JdoGetObjectId(final ClassEnhancer enhancer, final String name, final int access, final Object returnType, final Object[] argTypes, final String[] argNames) {
