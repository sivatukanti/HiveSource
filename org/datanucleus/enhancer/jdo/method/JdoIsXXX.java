...
{
    public JdoIsXXX(final ClassEnhancer enhancer, final String name, final int access, final Object returnType, final Object[] argTypes, final String[] argNames) {
    ...
    public void execute() {
        ...
        if (JavaUtils.useStackMapFrames()) {
            this.visitor.visitFrame(4, 0, null, 1, new Object[] { Opcodes.INTEGER });
        }
