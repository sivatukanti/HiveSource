...
public class BufferUtil
{
    ...
    public static String to8859_1_String(final Buffer buffer) {
        ...
        try {
            ...
            final StringBuffer b = new StringBuffer(buffer.length());
    ...
    static {
        ...
        BufferUtil.decDivisors = new int[] { 1000000000, 100000000, 10000000, 1000000, 100000, 10000, 1000, 100, 10, 1 };
        BufferUtil.hexDivisors = new int[] { 268435456, 16777216, 1048576, 65536, 4096, 256, 16, 1 };
