...
public class JSONPojoConvertor implements JSON.Convertor
{
    ...
    public JSONPojoConvertor(final Class pojoClass, final Set excluded) {
        this(pojoClass, excluded, true);
    }
    
    public JSONPojoConvertor(final Class pojoClass, final Set excluded, final boolean fromJSON) {
    ...
    public int setProps(final Object obj, final Map props) {
        ...
        for (final Map.Entry entry : props.entrySet()) {
            final Setter setter = this.getSetter(entry.getKey());
            if (setter != null) {
                try {
    ...
    public void toJSON(final Object obj, final JSON.Output out) {
        ...
        for (final Map.Entry entry : this._getters.entrySet()) {
            try {
    ...
    public static class Setter
    {
        ...
        protected void invokeObject(final Object obj, final Object value) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
            if (this._numberType != null && value instanceof Number) {
                this._method.invoke(obj, this._numberType.getActualValue((Number)value));
            }
                ...
                if (this._numberType == null) {
                    ...
                    try {
                        ...
                        Log.ignore(e);
                        this._method.invoke(obj, value);
                        return;
                    }
                    this._method.invoke(obj, array);
                }
                else {
