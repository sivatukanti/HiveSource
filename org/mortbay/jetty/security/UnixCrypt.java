...
public class UnixCrypt
{
    ...
    public static String crypt(final String key, final String setting) {
        ...
        return new String(cryptresult, 0, 0, 13);
    }
    ...
    static {
        ...
        UnixCrypt.A64TOI = new byte[128];
        UnixCrypt.PC1ROT = new long[16][16];
        UnixCrypt.PC2ROT = new long[2][16][16];
        UnixCrypt.IE3264 = new long[8][16];
        UnixCrypt.SPE = new long[8][64];
        UnixCrypt.CF6464 = new long[16][16];
