...
public class WebSocketGeneratorD08 implements WebSocketGenerator
{
    ...
    public WebSocketGeneratorD08(final WebSocketBuffers buffers, final EndPoint endp) {
    ...
    public WebSocketGeneratorD08(final WebSocketBuffers buffers, final EndPoint endp, final MaskGen maskGen) {
        this._mask = new byte[4];
        this._buffers = buffers;
        this._endp = endp;
    ...
    public synchronized void addFrame(final byte flags, byte opcode, final byte[] content, int offset, int length) throws IOException {
        ...
        final boolean last = WebSocketConnectionD08.isLastFrame(flags);
