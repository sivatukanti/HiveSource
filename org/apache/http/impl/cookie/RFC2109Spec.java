...
public class RFC2109Spec extends CookieSpecBase
{
    ...
    public RFC2109Spec(final String[] datepatterns, final boolean oneHeader) {
        super(new CommonCookieAttributeHandler[] { new RFC2109VersionHandler(), new BasicPathHandler(), new RFC2109DomainHandler(), new BasicMaxAgeHandler(), new BasicSecureHandler(), new BasicCommentHandler(), new BasicExpiresHandler((datepatterns != null) ? datepatterns.clone() : RFC2109Spec.DATE_PATTERNS) });
