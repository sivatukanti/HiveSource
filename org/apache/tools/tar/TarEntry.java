...
public class TarEntry implements TarConstants
{
    ...
    public TarEntry(final File file, final String fileName) {
        this();
        this.file = file;
        this.linkName = "";
        if (file.isDirectory()) {
    ...
    public TarEntry(final byte[] headerBuf, final ZipEncoding encoding) throws IOException {
        this();
    ...
    private static boolean matchAsciiBuffer(final String expected, final byte[] buffer, final int offset, final int length) {
        byte[] buffer2;
        try {
            buffer2 = expected.getBytes("ASCII");
        }
    ...
    private static boolean isEqual(final byte[] buffer1, final int offset1, final int length1, final byte[] buffer2, final int offset2, final int length2, final boolean ignoreTrailingNulls) {
