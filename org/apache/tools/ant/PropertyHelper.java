...
public class PropertyHelper implements GetProperty
{
    ...
    {
        boolean setNew(final String p0, final Object p1, final PropertyHelper p2);
        
        boolean set(final String p0, final Object p1, final PropertyHelper p2);
    }
    ...
    {
        Object evaluate(final String p0, final PropertyHelper p1);
    }
}
