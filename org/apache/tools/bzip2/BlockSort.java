...
class BlockSort
{
    ...
    private boolean mainSimpleSort(final CBZip2OutputStream.Data dataShadow, final int lo, final int hi, final int d, final int lastShadow) {
    ...
    private void mainQSort3(final CBZip2OutputStream.Data dataShadow, final int loSt, final int hiSt, final int dSt, final int last) {
