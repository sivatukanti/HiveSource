...
public final class FTPCommand
{
    ...
    static void checkArray() {
        ...
        if (FTPCommand._commands.length != expectedLength) {
            throw new RuntimeException("Incorrect _commands array. Should have length " + expectedLength + " found " + FTPCommand._commands.length);
        }
    }
