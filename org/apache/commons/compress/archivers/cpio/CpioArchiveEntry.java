...
public class CpioArchiveEntry implements CpioConstants, ArchiveEntry
{
    ...
    public int getHeaderPadCount() {
        ...
        final int size = this.headerSize + this.name.length() + 1;
    ...
    public long getNumberOfLinks() {
        return (this.nlink == 0L) ? (this.isDirectory() ? 2 : 1) : this.nlink;
    }
    ...
    public boolean isBlockDevice() {
        return (this.mode & 0xF000L) == 0x6000L;
    }
    
    public boolean isCharacterDevice() {
        return (this.mode & 0xF000L) == 0x2000L;
    }
    
    public boolean isDirectory() {
        return (this.mode & 0xF000L) == 0x4000L;
    }
    
    public boolean isNetwork() {
        return (this.mode & 0xF000L) == 0x9000L;
    }
    
    public boolean isPipe() {
        return (this.mode & 0xF000L) == 0x1000L;
    }
    
    public boolean isRegularFile() {
        return (this.mode & 0xF000L) == 0x8000L;
    }
    
    public boolean isSocket() {
        return (this.mode & 0xF000L) == 0xC000L;
    }
    
    public boolean isSymbolicLink() {
        return (this.mode & 0xF000L) == 0xA000L;
    }
