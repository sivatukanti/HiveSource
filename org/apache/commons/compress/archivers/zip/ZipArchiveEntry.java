...
public class ZipArchiveEntry extends ZipEntry implements ArchiveEntry
{
    ...
    public boolean equals(final Object obj) {
        ...
        final String myComment = this.getComment();
        final String otherComment = other.getComment();
        if (myComment == null) {
