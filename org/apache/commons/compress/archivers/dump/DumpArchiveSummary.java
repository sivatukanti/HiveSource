...
public class DumpArchiveSummary
{
    ...
    DumpArchiveSummary(final byte[] buffer) {
        ...
        this.label = new String(buffer, 676, 16).trim();
        this.level = DumpArchiveUtil.convert32(buffer, 692);
        this.filesys = new String(buffer, 696, 64).trim();
        this.devname = new String(buffer, 760, 64).trim();
        this.hostname = new String(buffer, 824, 64).trim();
