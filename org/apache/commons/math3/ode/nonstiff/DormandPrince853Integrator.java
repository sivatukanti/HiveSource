...
public class DormandPrince853Integrator extends EmbeddedRungeKuttaIntegrator
{
    ...
    public DormandPrince853Integrator(final double minStep, final double maxStep, final double scalAbsoluteTolerance, final double scalRelativeTolerance) {
        super("Dormand-Prince 8 (5, 3)", true, DormandPrince853Integrator.STATIC_C, DormandPrince853Integrator.STATIC_A, DormandPrince853Integrator.STATIC_B, new DormandPrince853StepInterpolator(), minStep, maxStep, scalAbsoluteTolerance, scalRelativeTolerance);
    }
    ...
    public DormandPrince853Integrator(final double minStep, final double maxStep, final double[] vecAbsoluteTolerance, final double[] vecRelativeTolerance) {
        super("Dormand-Prince 8 (5, 3)", true, DormandPrince853Integrator.STATIC_C, DormandPrince853Integrator.STATIC_A, DormandPrince853Integrator.STATIC_B, new DormandPrince853StepInterpolator(), minStep, maxStep, vecAbsoluteTolerance, vecRelativeTolerance);
    }
    ...
    protected double estimateError(final double[][] yDotK, final double[] y0, final double[] y1, final double h) {
        ...
        for (int j = 0; j < this.mainSetDimension; ++j) {
            final double errSum1 = 0.01312004499419488 * yDotK[0][j] + -1.2251564463762044 * yDotK[5][j] + -0.4957589496572502 * yDotK[6][j] + 1.6643771824549864 * yDotK[7][j] + -0.35032884874997366 * yDotK[8][j] + 0.3341791187130175 * yDotK[9][j] + 0.08192320648511571 * yDotK[10][j] + -0.022355307863886294 * yDotK[11][j];
            final double errSum2 = -0.18980075407240762 * yDotK[0][j] + 4.450312892752409 * yDotK[5][j] + 1.8915178993145003 * yDotK[6][j] + -5.801203960010585 * yDotK[7][j] + -0.42268232132379197 * yDotK[8][j] + -0.1521609496625161 * yDotK[9][j] + 0.20136540080403034 * yDotK[10][j] + 0.022651792198360825 * yDotK[11][j];
