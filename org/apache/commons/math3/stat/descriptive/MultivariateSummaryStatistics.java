...
public class MultivariateSummaryStatistics implements StatisticalMultivariateSummary, Serializable
{
    ...
    public MultivariateSummaryStatistics(final int k, final boolean isCovarianceBiasCorrected) {
        this.n = 0L;
        this.k = k;
    ...
    public void addValue(final double[] value) throws DimensionMismatchException {
    ...
    private void append(final StringBuilder buffer, final double[] data, final String prefix, final String separator, final String suffix) {
    ...
    private void setImpl(final StorelessUnivariateStatistic[] newImpl, final StorelessUnivariateStatistic[] oldImpl) throws MathIllegalStateException, DimensionMismatchException {
        this.checkEmpty();
    ...
    public void setSumImpl(final StorelessUnivariateStatistic[] sumImpl) throws MathIllegalStateException, DimensionMismatchException {
    ...
    public void setSumsqImpl(final StorelessUnivariateStatistic[] sumsqImpl) throws MathIllegalStateException, DimensionMismatchException {
    ...
    public void setMinImpl(final StorelessUnivariateStatistic[] minImpl) throws MathIllegalStateException, DimensionMismatchException {
    ...
    public void setMaxImpl(final StorelessUnivariateStatistic[] maxImpl) throws MathIllegalStateException, DimensionMismatchException {
    ...
    public void setSumLogImpl(final StorelessUnivariateStatistic[] sumLogImpl) throws MathIllegalStateException, DimensionMismatchException {
    ...
    public void setGeoMeanImpl(final StorelessUnivariateStatistic[] geoMeanImpl) throws MathIllegalStateException, DimensionMismatchException {
    ...
    public void setMeanImpl(final StorelessUnivariateStatistic[] meanImpl) throws MathIllegalStateException, DimensionMismatchException {
    ...
    private void checkDimension(final int dimension) throws DimensionMismatchException {
        if (dimension != this.k) {
