...
public abstract class XdrStructType extends AbstractXdrType<XdrStructType>
{
    ...
    public XdrStructType(final XdrDataType xdrDataType) {
        super(xdrDataType);
        this.fieldInfos = null;
        this.fields = null;
    }
    
    public XdrStructType(final XdrDataType xdrDataType, final XdrFieldInfo[] fieldInfos) {
        super(xdrDataType);
        if (fieldInfos != null) {
            this.fieldInfos = fieldInfos.clone();
            this.getStructTypeInstance(this.fields = new XdrType[fieldInfos.length], fieldInfos);
        }
        else {
            this.fieldInfos = null;
            this.fields = null;
    ...
    protected abstract void getStructTypeInstance(final XdrType[] p0, final XdrFieldInfo[] p1);
    ...
    protected abstract XdrStructType fieldsToValues(final AbstractXdrType[] p0);
