...
public class TServerSocket extends TServerTransport
{
    ...
    public TServerSocket(final ServerSocket serverSocket) throws TTransportException {
        this(serverSocket, 0);
    }
    
    public TServerSocket(final ServerSocket serverSocket, final int clientTimeout) throws TTransportException {
    ...
    public TServerSocket(final ServerSocketTransportArgs args) throws TTransportException {
    ...
    public static class ServerSocketTransportArgs extends AbstractServerTransportArgs<ServerSocketTransportArgs>
    {
        ...
        public ServerSocketTransportArgs serverSocket(final ServerSocket serverSocket) {
