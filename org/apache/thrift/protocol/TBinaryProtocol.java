...
public class TBinaryProtocol extends TProtocol
{
    ...
    public TBinaryProtocol(final TTransport trans, final long stringLengthLimit, final long containerLengthLimit, final boolean strictRead, final boolean strictWrite) {
        super(trans);
    ...
    public TMap readMapBegin() throws TException {
        final TMap map = new TMap(this.readByte(), this.readByte(), this.readI32());
    ...
    public TList readListBegin() throws TException {
        final TList list = new TList(this.readByte(), this.readI32());
    ...
    public TSet readSetBegin() throws TException {
        final TSet set = new TSet(this.readByte(), this.readI32());
    ...
    public String readString() throws TException {
        ...
        if (this.stringLengthLimit_ > 0L && size > this.stringLengthLimit_) {
    ...
    public static class Factory implements TProtocolFactory
    {
        ...
        public Factory(final boolean strictRead, final boolean strictWrite, final long stringLengthLimit, final long containerLengthLimit) {
            this.stringLengthLimit_ = stringLengthLimit;
            this.containerLengthLimit_ = containerLengthLimit;
            this.strictRead_ = strictRead;
            this.strictWrite_ = strictWrite;
