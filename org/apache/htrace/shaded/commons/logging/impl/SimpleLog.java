...
{
    protected static final String systemPrefix = "org.apache.htrace.shaded.commons.logging.simplelog.";
    ...
    public SimpleLog(String name) {
        ...
        this.logName = name;
        this.setLevel(3);
        String lvl = getStringProperty("org.apache.htrace.shaded.commons.logging.simplelog.log." + this.logName);
        for (int i = String.valueOf(name).lastIndexOf("."); null == lvl && i > -1; lvl = getStringProperty("org.apache.htrace.shaded.commons.logging.simplelog.log." + name), i = String.valueOf(name).lastIndexOf(".")) {
            name = name.substring(0, i);
        }
        if (null == lvl) {
            lvl = getStringProperty("org.apache.htrace.shaded.commons.logging.simplelog.defaultlog");
        }
    ...
    static {
        ...
        SimpleLog.showLogName = getBooleanProperty("org.apache.htrace.shaded.commons.logging.simplelog.showlogname", SimpleLog.showLogName);
        SimpleLog.showShortName = getBooleanProperty("org.apache.htrace.shaded.commons.logging.simplelog.showShortLogname", SimpleLog.showShortName);
        SimpleLog.showDateTime = getBooleanProperty("org.apache.htrace.shaded.commons.logging.simplelog.showdatetime", SimpleLog.showDateTime);
        if (SimpleLog.showDateTime) {
            SimpleLog.dateTimeFormat = getStringProperty("org.apache.htrace.shaded.commons.logging.simplelog.dateTimeFormat", SimpleLog.dateTimeFormat);
            try {
