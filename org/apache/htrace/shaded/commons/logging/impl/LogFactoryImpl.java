...
import org.apache.htrace.shaded.commons.logging.LogConfigurationException;
...
{
    private static final String LOGGING_IMPL_LOG4J_LOGGER = "org.apache.htrace.shaded.commons.logging.impl.Log4JLogger";
    private static final String LOGGING_IMPL_JDK14_LOGGER = "org.apache.htrace.shaded.commons.logging.impl.Jdk14Logger";
    private static final String LOGGING_IMPL_LUMBERJACK_LOGGER = "org.apache.htrace.shaded.commons.logging.impl.Jdk13LumberjackLogger";
    private static final String LOGGING_IMPL_SIMPLE_LOGGER = "org.apache.htrace.shaded.commons.logging.impl.SimpleLog";
    private static final String PKG_IMPL = "org.apache.htrace.shaded.commons.logging.impl.";
    private static final int PKG_LEN;
    public static final String LOG_PROPERTY = "org.apache.htrace.shaded.commons.logging.Log";
    protected static final String LOG_PROPERTY_OLD = "org.apache.htrace.shaded.commons.logging.log";
    public static final String ALLOW_FLAWED_CONTEXT_PROPERTY = "org.apache.htrace.shaded.commons.logging.Log.allowFlawedContext";
    public static final String ALLOW_FLAWED_DISCOVERY_PROPERTY = "org.apache.htrace.shaded.commons.logging.Log.allowFlawedDiscovery";
    public static final String ALLOW_FLAWED_HIERARCHY_PROPERTY = "org.apache.htrace.shaded.commons.logging.Log.allowFlawedHierarchy";
    ...
    protected boolean isJdk13LumberjackAvailable() {
        return this.isLogLibraryAvailable("Jdk13Lumberjack", "org.apache.htrace.shaded.commons.logging.impl.Jdk13LumberjackLogger");
    }
    
    protected boolean isJdk14Available() {
        return this.isLogLibraryAvailable("Jdk14", "org.apache.htrace.shaded.commons.logging.impl.Jdk14Logger");
    }
    
    protected boolean isLog4JAvailable() {
        return this.isLogLibraryAvailable("Log4J", "org.apache.htrace.shaded.commons.logging.impl.Log4JLogger");
    }
    ...
    private void initConfiguration() {
        this.allowFlawedContext = this.getBooleanConfiguration("org.apache.htrace.shaded.commons.logging.Log.allowFlawedContext", true);
        this.allowFlawedDiscovery = this.getBooleanConfiguration("org.apache.htrace.shaded.commons.logging.Log.allowFlawedDiscovery", true);
        this.allowFlawedHierarchy = this.getBooleanConfiguration("org.apache.htrace.shaded.commons.logging.Log.allowFlawedHierarchy", true);
    }
    ...
    private Log discoverLogImplementation(final String logCategory) throws LogConfigurationException {
        ...
        if (specifiedLogClassName != null) {
            ...
            if (result == null) {
                ...
                if (specifiedLogClassName != null) {
                    this.informUponSimilarName(messageBuffer, specifiedLogClassName, "org.apache.htrace.shaded.commons.logging.impl.Log4JLogger");
                    this.informUponSimilarName(messageBuffer, specifiedLogClassName, "org.apache.htrace.shaded.commons.logging.impl.Jdk14Logger");
                    this.informUponSimilarName(messageBuffer, specifiedLogClassName, "org.apache.htrace.shaded.commons.logging.impl.Jdk13LumberjackLogger");
                    this.informUponSimilarName(messageBuffer, specifiedLogClassName, "org.apache.htrace.shaded.commons.logging.impl.SimpleLog");
                }
    ...
    private String findUserSpecifiedLogClassName() {
        ...
        String specifiedClass = (String)this.getAttribute("org.apache.htrace.shaded.commons.logging.Log");
        if (specifiedClass == null) {
            if (isDiagnosticsEnabled()) {
                this.logDiagnostic("Trying to get log class from attribute 'org.apache.commons.logging.log'");
            }
            specifiedClass = (String)this.getAttribute("org.apache.htrace.shaded.commons.logging.log");
        }
        if (specifiedClass == null) {
            if (isDiagnosticsEnabled()) {
            ...
            try {
                specifiedClass = getSystemProperty("org.apache.htrace.shaded.commons.logging.Log", null);
            }
            catch (SecurityException e) {
                if (isDiagnosticsEnabled()) {
    ...
    static {
        PKG_LEN = "org.apache.htrace.shaded.commons.logging.impl.".length();
        classesToDiscover = new String[] { "org.apache.htrace.shaded.commons.logging.impl.Log4JLogger", "org.apache.htrace.shaded.commons.logging.impl.Jdk14Logger", "org.apache.htrace.shaded.commons.logging.impl.Jdk13LumberjackLogger", "org.apache.htrace.shaded.commons.logging.impl.SimpleLog" };
    }
}
