...
public final class WriterBasedJsonGenerator extends JsonGeneratorImpl
{
    ...
    protected void _writeFieldName(final String name, final boolean commaBefore) throws IOException {
        if (this._cfgPrettyPrinter != null) {
    ...
    protected void _writeFieldName(final SerializableString name, final boolean commaBefore) throws IOException {
        if (this._cfgPrettyPrinter != null) {
            this._writePPFieldName(name, commaBefore);
            return;
        }
    ...
    protected void _writePPFieldName(final String name, final boolean commaBefore) throws IOException, JsonGenerationException {
        if (commaBefore) {
    ...
    protected void _writePPFieldName(final SerializableString name, final boolean commaBefore) throws IOException, JsonGenerationException {
        if (commaBefore) {
            this._cfgPrettyPrinter.writeObjectEntrySeparator(this);
        }
        else {
    ...
    private void _writeQuotedRaw(final Object value) throws IOException {
        if (this._outputTail >= this._outputEnd) {
            this._flushBuffer();
        }
        this._outputBuffer[this._outputTail++] = '\"';
    ...
    protected void _verifyValueWrite(final String typeMsg) throws IOException {
        if (this._cfgPrettyPrinter != null) {
            this._verifyPrettyValueWrite(typeMsg);
            return;
        }
    ...
    protected void _verifyPrettyValueWrite(final String typeMsg) throws IOException {
        final int status = this._writeContext.writeValue();
        if (status == 5) {
            this._reportError("Can not " + typeMsg + ", expecting field name");
        }
    ...
    protected int _writeBinary(final Base64Variant b64variant, final InputStream data, final byte[] readBuffer, int bytesLeft) throws IOException, JsonGenerationException {
        int inputPtr = 0;
        int inputEnd = 0;
    ...
    protected int _writeBinary(final Base64Variant b64variant, final InputStream data, final byte[] readBuffer) throws IOException, JsonGenerationException {
        int inputPtr = 0;
        int inputEnd = 0;
        int lastFullOffset = -3;
        int bytesDone = 0;
