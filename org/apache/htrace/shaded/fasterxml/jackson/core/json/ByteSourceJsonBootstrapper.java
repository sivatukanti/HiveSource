...
import org.apache.htrace.shaded.fasterxml.jackson.core.io.UTF32Reader;
import java.io.InputStreamReader;
import org.apache.htrace.shaded.fasterxml.jackson.core.io.MergedStream;
...
public final class ByteSourceJsonBootstrapper
{
    ...
    public JsonParser constructParser(final int parserFeatures, final ObjectCodec codec, final BytesToNameCanonicalizer rootByteSymbols, final CharsToNameCanonicalizer rootCharSymbols, final int factoryFeatures) throws IOException {
        ...
        if (enc == JsonEncoding.UTF8 && JsonFactory.Feature.CANONICALIZE_FIELD_NAMES.enabledIn(factoryFeatures)) {
            final BytesToNameCanonicalizer can = rootByteSymbols.makeChild(factoryFeatures);
