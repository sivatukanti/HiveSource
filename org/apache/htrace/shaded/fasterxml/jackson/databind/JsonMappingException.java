...
public class JsonMappingException extends JsonProcessingException
{
    ...
    public static JsonMappingException fromUnexpectedIOE(final IOException src) {
        return new JsonMappingException("Unexpected IOException (of type " + src.getClass().getName() + "): " + src.getMessage(), null, src);
    }
    ...
    public static class Reference implements Serializable
    {
        ...
        public String toString() {
            ...
            final Class<?> cls = (Class<?>)((this._from instanceof Class) ? ((Class)this._from) : this._from.getClass());
