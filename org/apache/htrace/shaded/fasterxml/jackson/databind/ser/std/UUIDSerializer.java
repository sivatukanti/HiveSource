...
public class UUIDSerializer extends StdScalarSerializer<UUID>
{
    ...
    @Override
    public boolean isEmpty(final UUID value) {
        return value == null || (value.getLeastSignificantBits() == 0L && value.getMostSignificantBits() == 0L);
    }
    
    @Override
    public void serialize(final UUID value, final JsonGenerator jgen, final SerializerProvider provider) throws IOException, JsonGenerationException {
