...
import org.apache.htrace.shaded.fasterxml.jackson.databind.annotation.NoClass;
...
public final class ClassUtil
{
    ...
    public static final boolean isBogusClass(final Class<?> cls) {
    ...
    private static class EnumTypeLocator
    {
        ...
        private static Field locateField(final Class<?> fromClass, final String expectedName, final Class<?> type) {
            Field found = null;
            Field[] arr$;
            final Field[] fields = arr$ = fromClass.getDeclaredFields();
