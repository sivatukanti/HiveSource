...
public final class MoreExecutors
{
    ...
    public static ThreadFactory platformThreadFactory() {
        ...
        try {
            return (ThreadFactory)Class.forName("org.apache.curator.shaded.com.google.appengine.api.ThreadManager").getMethod("currentRequestThreadFactory", (Class<?>[])new Class[0]).invoke(null, new Object[0]);
        }
    ...
    private static boolean isAppEngine() {
        ...
        try {
            return Class.forName("org.apache.curator.shaded.com.google.apphosting.api.ApiProxy").getMethod("getCurrentEnvironment", (Class<?>[])new Class[0]).invoke(null, new Object[0]) != null;
        }
