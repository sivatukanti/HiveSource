...
public class TGetTablesResp implements TBase<TGetTablesResp, _Fields>, Serializable, Cloneable
{
    ...
    public TGetTablesResp(final TStatus status) {
        this();
        this.status = status;
    }
    
    public TGetTablesResp(final TGetTablesResp other) {
        this.optionals = new _Fields[] { _Fields.OPERATION_HANDLE };
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TGetTablesResp && this.equals((TGetTablesResp)that);
    }
    
    public boolean equals(final TGetTablesResp that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TGetTablesResp other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TGetTablesResp typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TGetTablesResp.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TGetTablesResp.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TGetTablesResp(");
        boolean first = true;
        sb.append("status:");
        if (this.status == null) {
            sb.append("null");
    ...
    static {
        STRUCT_DESC = new TStruct("TGetTablesResp");
        ...
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TGetTablesRespStandardSchemeFactory());
        TGetTablesResp.schemes.put(TupleScheme.class, new TGetTablesRespTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TGetTablesResp.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TGetTablesResp struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TGetTablesResp struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TGetTablesResp struct) throws TException {
        ...
        @Override
        public void read(final TProtocol prot, final TGetTablesResp struct) throws TException {
