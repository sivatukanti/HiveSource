...
public class TStructTypeEntry implements TBase<TStructTypeEntry, _Fields>, Serializable, Cloneable
{
    ...
    public TStructTypeEntry(final Map<String, Integer> nameToTypePtr) {
        this();
        this.nameToTypePtr = nameToTypePtr;
    }
    
    public TStructTypeEntry(final TStructTypeEntry other) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TStructTypeEntry && this.equals((TStructTypeEntry)that);
    }
    
    public boolean equals(final TStructTypeEntry that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TStructTypeEntry other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TStructTypeEntry typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TStructTypeEntry.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TStructTypeEntry.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TStructTypeEntry(");
        boolean first = true;
    ...
    static {
        STRUCT_DESC = new TStruct("TStructTypeEntry");
        NAME_TO_TYPE_PTR_FIELD_DESC = new TField("nameToTypePtr", (byte)13, (short)1);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TStructTypeEntryStandardSchemeFactory());
        TStructTypeEntry.schemes.put(TupleScheme.class, new TStructTypeEntryTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TStructTypeEntry.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TStructTypeEntry struct) throws TException {
                ...
                switch (schemeField.id) {
                    case 1: {
                        if (schemeField.type == 13) {
                            ...
                            struct.nameToTypePtr = (Map<String, Integer>)new HashMap(2 * _map10.size);
                            for (int _i11 = 0; _i11 < _map10.size; ++_i11) {
                                final String _key12 = iprot.readString();
                                final int _val13 = iprot.readI32();
        ...
        @Override
        public void write(final TProtocol oprot, final TStructTypeEntry struct) throws TException {
            struct.validate();
            ...
            if (struct.nameToTypePtr != null) {
                ...
                for (final Map.Entry<String, Integer> _iter14 : struct.nameToTypePtr.entrySet()) {
    ...
    {
        @Override
        public void write(final TProtocol prot, final TStructTypeEntry struct) throws TException {
            final TTupleProtocol oprot = (TTupleProtocol)prot;
            oprot.writeI32(struct.nameToTypePtr.size());
            for (final Map.Entry<String, Integer> _iter15 : struct.nameToTypePtr.entrySet()) {
        ...
        @Override
        public void read(final TProtocol prot, final TStructTypeEntry struct) throws TException {
            final TTupleProtocol iprot = (TTupleProtocol)prot;
            final TMap _map16 = new TMap((byte)11, (byte)8, iprot.readI32());
            struct.nameToTypePtr = (Map<String, Integer>)new HashMap(2 * _map16.size);
            for (int _i17 = 0; _i17 < _map16.size; ++_i17) {
                final String _key18 = iprot.readString();
                final int _val19 = iprot.readI32();
