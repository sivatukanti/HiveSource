...
public class TBoolColumn implements TBase<TBoolColumn, _Fields>, Serializable, Cloneable
{
    ...
    public TBoolColumn(final List<Boolean> values, final ByteBuffer nulls) {
        this();
        this.values = values;
        this.nulls = nulls;
    }
    
    public TBoolColumn(final TBoolColumn other) {
        if (other.isSetValues()) {
            final List<Boolean> __this__values = new ArrayList<Boolean>();
            for (final Boolean other_element : other.values) {
    ...
    public Iterator<Boolean> getValuesIterator() {
        return (this.values == null) ? null : this.values.iterator();
    }
    
    public void addToValues(final boolean elem) {
        if (this.values == null) {
    ...
    public void setFieldValue(final _Fields field, final Object value) {
        switch (field) {
            case VALUES: {
                ...
                this.setValues((List<Boolean>)value);
                break;
            }
            case NULLS: {
                if (value == null) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TBoolColumn && this.equals((TBoolColumn)that);
    }
    
    public boolean equals(final TBoolColumn that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TBoolColumn other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TBoolColumn typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TBoolColumn.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TBoolColumn.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TBoolColumn(");
        boolean first = true;
        sb.append("values:");
        if (this.values == null) {
            sb.append("null");
    ...
    static {
        STRUCT_DESC = new TStruct("TBoolColumn");
        VALUES_FIELD_DESC = new TField("values", (byte)15, (short)1);
        NULLS_FIELD_DESC = new TField("nulls", (byte)11, (short)2);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TBoolColumnStandardSchemeFactory());
        TBoolColumn.schemes.put(TupleScheme.class, new TBoolColumnTupleSchemeFactory());
        final Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
        tmpMap.put(_Fields.VALUES, new FieldMetaData("values", (byte)1, new ListMetaData((byte)15, new FieldValueMetaData((byte)2))));
        tmpMap.put(_Fields.NULLS, new FieldMetaData("nulls", (byte)1, new FieldValueMetaData((byte)11, true)));
        FieldMetaData.addStructMetaDataMap(TBoolColumn.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TBoolColumn struct) throws TException {
                ...
                switch (schemeField.id) {
                    case 1: {
                        if (schemeField.type == 15) {
                            final TList _list54 = iprot.readListBegin();
                            struct.values = (List<Boolean>)new ArrayList(_list54.size);
                            for (int _i55 = 0; _i55 < _list54.size; ++_i55) {
                                final boolean _elem56 = iprot.readBool();
        ...
        @Override
        public void write(final TProtocol oprot, final TBoolColumn struct) throws TException {
            struct.validate();
            ...
            if (struct.values != null) {
                ...
                for (final boolean _iter57 : struct.values) {
    ...
    {
        @Override
        public void write(final TProtocol prot, final TBoolColumn struct) throws TException {
            final TTupleProtocol oprot = (TTupleProtocol)prot;
            oprot.writeI32(struct.values.size());
            for (final boolean _iter58 : struct.values) {
        ...
        @Override
        public void read(final TProtocol prot, final TBoolColumn struct) throws TException {
            final TTupleProtocol iprot = (TTupleProtocol)prot;
            final TList _list59 = new TList((byte)2, iprot.readI32());
            struct.values = (List<Boolean>)new ArrayList(_list59.size);
            for (int _i60 = 0; _i60 < _list59.size; ++_i60) {
                final boolean _elem61 = iprot.readBool();
