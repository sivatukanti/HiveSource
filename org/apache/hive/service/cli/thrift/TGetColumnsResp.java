...
public class TGetColumnsResp implements TBase<TGetColumnsResp, _Fields>, Serializable, Cloneable
{
    ...
    public TGetColumnsResp(final TStatus status) {
        this();
        this.status = status;
    }
    
    public TGetColumnsResp(final TGetColumnsResp other) {
        this.optionals = new _Fields[] { _Fields.OPERATION_HANDLE };
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TGetColumnsResp && this.equals((TGetColumnsResp)that);
    }
    
    public boolean equals(final TGetColumnsResp that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TGetColumnsResp other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TGetColumnsResp typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TGetColumnsResp.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TGetColumnsResp.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TGetColumnsResp(");
        boolean first = true;
        sb.append("status:");
        if (this.status == null) {
            sb.append("null");
    ...
    static {
        STRUCT_DESC = new TStruct("TGetColumnsResp");
        ...
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TGetColumnsRespStandardSchemeFactory());
        TGetColumnsResp.schemes.put(TupleScheme.class, new TGetColumnsRespTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TGetColumnsResp.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TGetColumnsResp struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TGetColumnsResp struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TGetColumnsResp struct) throws TException {
        ...
        @Override
        public void read(final TProtocol prot, final TGetColumnsResp struct) throws TException {
