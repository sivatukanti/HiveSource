...
public class TExecuteStatementResp implements TBase<TExecuteStatementResp, _Fields>, Serializable, Cloneable
{
    ...
    public TExecuteStatementResp(final TStatus status) {
        this();
        this.status = status;
    }
    
    public TExecuteStatementResp(final TExecuteStatementResp other) {
        this.optionals = new _Fields[] { _Fields.OPERATION_HANDLE };
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TExecuteStatementResp && this.equals((TExecuteStatementResp)that);
    }
    
    public boolean equals(final TExecuteStatementResp that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TExecuteStatementResp other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TExecuteStatementResp typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TExecuteStatementResp.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TExecuteStatementResp.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TExecuteStatementResp(");
        boolean first = true;
        sb.append("status:");
        if (this.status == null) {
            sb.append("null");
    ...
    static {
        STRUCT_DESC = new TStruct("TExecuteStatementResp");
        ...
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TExecuteStatementRespStandardSchemeFactory());
        TExecuteStatementResp.schemes.put(TupleScheme.class, new TExecuteStatementRespTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TExecuteStatementResp.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TExecuteStatementResp struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TExecuteStatementResp struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TExecuteStatementResp struct) throws TException {
        ...
        @Override
        public void read(final TProtocol prot, final TExecuteStatementResp struct) throws TException {
