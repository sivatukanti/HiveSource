...
public class TCloseSessionReq implements TBase<TCloseSessionReq, _Fields>, Serializable, Cloneable
{
    ...
    public TCloseSessionReq(final TSessionHandle sessionHandle) {
        this();
        this.sessionHandle = sessionHandle;
    }
    
    public TCloseSessionReq(final TCloseSessionReq other) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TCloseSessionReq && this.equals((TCloseSessionReq)that);
    }
    
    public boolean equals(final TCloseSessionReq that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TCloseSessionReq other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TCloseSessionReq typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TCloseSessionReq.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TCloseSessionReq.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TCloseSessionReq(");
        boolean first = true;
    ...
    static {
        STRUCT_DESC = new TStruct("TCloseSessionReq");
        SESSION_HANDLE_FIELD_DESC = new TField("sessionHandle", (byte)12, (short)1);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TCloseSessionReqStandardSchemeFactory());
        TCloseSessionReq.schemes.put(TupleScheme.class, new TCloseSessionReqTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TCloseSessionReq.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TCloseSessionReq struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TCloseSessionReq struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TCloseSessionReq struct) throws TException {
            final TTupleProtocol oprot = (TTupleProtocol)prot;
            struct.sessionHandle.write(oprot);
        }
        
        @Override
        public void read(final TProtocol prot, final TCloseSessionReq struct) throws TException {
