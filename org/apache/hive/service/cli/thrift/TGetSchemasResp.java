...
public class TGetSchemasResp implements TBase<TGetSchemasResp, _Fields>, Serializable, Cloneable
{
    ...
    public TGetSchemasResp(final TStatus status) {
        this();
        this.status = status;
    }
    
    public TGetSchemasResp(final TGetSchemasResp other) {
        this.optionals = new _Fields[] { _Fields.OPERATION_HANDLE };
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TGetSchemasResp && this.equals((TGetSchemasResp)that);
    }
    
    public boolean equals(final TGetSchemasResp that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TGetSchemasResp other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TGetSchemasResp typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TGetSchemasResp.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TGetSchemasResp.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TGetSchemasResp(");
        boolean first = true;
        sb.append("status:");
        if (this.status == null) {
            sb.append("null");
    ...
    static {
        STRUCT_DESC = new TStruct("TGetSchemasResp");
        ...
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TGetSchemasRespStandardSchemeFactory());
        TGetSchemasResp.schemes.put(TupleScheme.class, new TGetSchemasRespTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TGetSchemasResp.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TGetSchemasResp struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TGetSchemasResp struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TGetSchemasResp struct) throws TException {
        ...
        @Override
        public void read(final TProtocol prot, final TGetSchemasResp struct) throws TException {
