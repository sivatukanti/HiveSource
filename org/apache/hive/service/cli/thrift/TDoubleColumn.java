...
public class TDoubleColumn implements TBase<TDoubleColumn, _Fields>, Serializable, Cloneable
{
    ...
    public TDoubleColumn(final List<Double> values, final ByteBuffer nulls) {
        this();
        this.values = values;
        this.nulls = nulls;
    }
    
    public TDoubleColumn(final TDoubleColumn other) {
        if (other.isSetValues()) {
            final List<Double> __this__values = new ArrayList<Double>();
            for (final Double other_element : other.values) {
    ...
    public void addToValues(final double elem) {
        if (this.values == null) {
    ...
    public void setFieldValue(final _Fields field, final Object value) {
        switch (field) {
            case VALUES: {
                ...
                this.setValues((List<Double>)value);
                break;
            }
            case NULLS: {
                if (value == null) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TDoubleColumn && this.equals((TDoubleColumn)that);
    }
    
    public boolean equals(final TDoubleColumn that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TDoubleColumn other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TDoubleColumn typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TDoubleColumn.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TDoubleColumn.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TDoubleColumn(");
        boolean first = true;
        sb.append("values:");
        if (this.values == null) {
            sb.append("null");
    ...
    static {
        STRUCT_DESC = new TStruct("TDoubleColumn");
        VALUES_FIELD_DESC = new TField("values", (byte)15, (short)1);
        NULLS_FIELD_DESC = new TField("nulls", (byte)11, (short)2);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TDoubleColumnStandardSchemeFactory());
        TDoubleColumn.schemes.put(TupleScheme.class, new TDoubleColumnTupleSchemeFactory());
        final Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
        tmpMap.put(_Fields.VALUES, new FieldMetaData("values", (byte)1, new ListMetaData((byte)15, new FieldValueMetaData((byte)4))));
        tmpMap.put(_Fields.NULLS, new FieldMetaData("nulls", (byte)1, new FieldValueMetaData((byte)11, true)));
        FieldMetaData.addStructMetaDataMap(TDoubleColumn.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TDoubleColumn struct) throws TException {
                ...
                switch (schemeField.id) {
                    case 1: {
                        if (schemeField.type == 15) {
                            final TList _list94 = iprot.readListBegin();
                            struct.values = (List<Double>)new ArrayList(_list94.size);
                            for (int _i95 = 0; _i95 < _list94.size; ++_i95) {
                                final double _elem96 = iprot.readDouble();
        ...
        @Override
        public void write(final TProtocol oprot, final TDoubleColumn struct) throws TException {
            struct.validate();
            ...
            if (struct.values != null) {
                ...
                for (final double _iter97 : struct.values) {
    ...
    {
        @Override
        public void write(final TProtocol prot, final TDoubleColumn struct) throws TException {
            final TTupleProtocol oprot = (TTupleProtocol)prot;
            oprot.writeI32(struct.values.size());
            for (final double _iter98 : struct.values) {
        ...
        @Override
        public void read(final TProtocol prot, final TDoubleColumn struct) throws TException {
            final TTupleProtocol iprot = (TTupleProtocol)prot;
            final TList _list99 = new TList((byte)4, iprot.readI32());
            struct.values = (List<Double>)new ArrayList(_list99.size);
            for (int _i100 = 0; _i100 < _list99.size; ++_i100) {
                final double _elem101 = iprot.readDouble();
