...
public class TCloseOperationResp implements TBase<TCloseOperationResp, _Fields>, Serializable, Cloneable
{
    ...
    public TCloseOperationResp(final TStatus status) {
        this();
        this.status = status;
    }
    
    public TCloseOperationResp(final TCloseOperationResp other) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TCloseOperationResp && this.equals((TCloseOperationResp)that);
    }
    
    public boolean equals(final TCloseOperationResp that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TCloseOperationResp other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TCloseOperationResp typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TCloseOperationResp.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TCloseOperationResp.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TCloseOperationResp(");
        boolean first = true;
        sb.append("status:");
        if (this.status == null) {
            sb.append("null");
    ...
    static {
        STRUCT_DESC = new TStruct("TCloseOperationResp");
        STATUS_FIELD_DESC = new TField("status", (byte)12, (short)1);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TCloseOperationRespStandardSchemeFactory());
        TCloseOperationResp.schemes.put(TupleScheme.class, new TCloseOperationRespTupleSchemeFactory());
        final Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
        tmpMap.put(_Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
        FieldMetaData.addStructMetaDataMap(TCloseOperationResp.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TCloseOperationResp struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TCloseOperationResp struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TCloseOperationResp struct) throws TException {
            final TTupleProtocol oprot = (TTupleProtocol)prot;
            struct.status.write(oprot);
        }
        
        @Override
        public void read(final TProtocol prot, final TCloseOperationResp struct) throws TException {
