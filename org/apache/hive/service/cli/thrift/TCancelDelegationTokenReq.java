...
public class TCancelDelegationTokenReq implements TBase<TCancelDelegationTokenReq, _Fields>, Serializable, Cloneable
{
    ...
    public TCancelDelegationTokenReq(final TSessionHandle sessionHandle, final String delegationToken) {
        this();
        this.sessionHandle = sessionHandle;
        this.delegationToken = delegationToken;
    }
    
    public TCancelDelegationTokenReq(final TCancelDelegationTokenReq other) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TCancelDelegationTokenReq && this.equals((TCancelDelegationTokenReq)that);
    }
    
    public boolean equals(final TCancelDelegationTokenReq that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TCancelDelegationTokenReq other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TCancelDelegationTokenReq typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TCancelDelegationTokenReq.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TCancelDelegationTokenReq.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TCancelDelegationTokenReq(");
        boolean first = true;
    ...
    static {
        STRUCT_DESC = new TStruct("TCancelDelegationTokenReq");
        ...
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TCancelDelegationTokenReqStandardSchemeFactory());
        TCancelDelegationTokenReq.schemes.put(TupleScheme.class, new TCancelDelegationTokenReqTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TCancelDelegationTokenReq.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TCancelDelegationTokenReq struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TCancelDelegationTokenReq struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TCancelDelegationTokenReq struct) throws TException {
        ...
        @Override
        public void read(final TProtocol prot, final TCancelDelegationTokenReq struct) throws TException {
