...
public class TCloseOperationReq implements TBase<TCloseOperationReq, _Fields>, Serializable, Cloneable
{
    ...
    public TCloseOperationReq(final TOperationHandle operationHandle) {
        this();
        this.operationHandle = operationHandle;
    }
    
    public TCloseOperationReq(final TCloseOperationReq other) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TCloseOperationReq && this.equals((TCloseOperationReq)that);
    }
    
    public boolean equals(final TCloseOperationReq that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TCloseOperationReq other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TCloseOperationReq typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TCloseOperationReq.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TCloseOperationReq.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TCloseOperationReq(");
        boolean first = true;
    ...
    static {
        STRUCT_DESC = new TStruct("TCloseOperationReq");
        OPERATION_HANDLE_FIELD_DESC = new TField("operationHandle", (byte)12, (short)1);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TCloseOperationReqStandardSchemeFactory());
        TCloseOperationReq.schemes.put(TupleScheme.class, new TCloseOperationReqTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TCloseOperationReq.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TCloseOperationReq struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TCloseOperationReq struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TCloseOperationReq struct) throws TException {
            final TTupleProtocol oprot = (TTupleProtocol)prot;
            struct.operationHandle.write(oprot);
        }
        
        @Override
        public void read(final TProtocol prot, final TCloseOperationReq struct) throws TException {
