...
public class TGetTypeInfoResp implements TBase<TGetTypeInfoResp, _Fields>, Serializable, Cloneable
{
    ...
    public TGetTypeInfoResp(final TStatus status) {
        this();
        this.status = status;
    }
    
    public TGetTypeInfoResp(final TGetTypeInfoResp other) {
        this.optionals = new _Fields[] { _Fields.OPERATION_HANDLE };
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TGetTypeInfoResp && this.equals((TGetTypeInfoResp)that);
    }
    
    public boolean equals(final TGetTypeInfoResp that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TGetTypeInfoResp other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TGetTypeInfoResp typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TGetTypeInfoResp.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TGetTypeInfoResp.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TGetTypeInfoResp(");
        boolean first = true;
        sb.append("status:");
        if (this.status == null) {
            sb.append("null");
    ...
    static {
        STRUCT_DESC = new TStruct("TGetTypeInfoResp");
        ...
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TGetTypeInfoRespStandardSchemeFactory());
        TGetTypeInfoResp.schemes.put(TupleScheme.class, new TGetTypeInfoRespTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TGetTypeInfoResp.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TGetTypeInfoResp struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TGetTypeInfoResp struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TGetTypeInfoResp struct) throws TException {
        ...
        @Override
        public void read(final TProtocol prot, final TGetTypeInfoResp struct) throws TException {
