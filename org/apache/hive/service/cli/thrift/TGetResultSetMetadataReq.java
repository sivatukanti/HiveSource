...
public class TGetResultSetMetadataReq implements TBase<TGetResultSetMetadataReq, _Fields>, Serializable, Cloneable
{
    ...
    public TGetResultSetMetadataReq(final TOperationHandle operationHandle) {
        this();
        this.operationHandle = operationHandle;
    }
    
    public TGetResultSetMetadataReq(final TGetResultSetMetadataReq other) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TGetResultSetMetadataReq && this.equals((TGetResultSetMetadataReq)that);
    }
    
    public boolean equals(final TGetResultSetMetadataReq that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TGetResultSetMetadataReq other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TGetResultSetMetadataReq typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TGetResultSetMetadataReq.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TGetResultSetMetadataReq.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TGetResultSetMetadataReq(");
        boolean first = true;
    ...
    static {
        STRUCT_DESC = new TStruct("TGetResultSetMetadataReq");
        OPERATION_HANDLE_FIELD_DESC = new TField("operationHandle", (byte)12, (short)1);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TGetResultSetMetadataReqStandardSchemeFactory());
        TGetResultSetMetadataReq.schemes.put(TupleScheme.class, new TGetResultSetMetadataReqTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TGetResultSetMetadataReq.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TGetResultSetMetadataReq struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TGetResultSetMetadataReq struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TGetResultSetMetadataReq struct) throws TException {
            final TTupleProtocol oprot = (TTupleProtocol)prot;
            struct.operationHandle.write(oprot);
        }
        
        @Override
        public void read(final TProtocol prot, final TGetResultSetMetadataReq struct) throws TException {
