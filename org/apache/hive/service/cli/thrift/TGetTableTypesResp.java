...
public class TGetTableTypesResp implements TBase<TGetTableTypesResp, _Fields>, Serializable, Cloneable
{
    ...
    public TGetTableTypesResp(final TStatus status) {
        this();
        this.status = status;
    }
    
    public TGetTableTypesResp(final TGetTableTypesResp other) {
        this.optionals = new _Fields[] { _Fields.OPERATION_HANDLE };
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TGetTableTypesResp && this.equals((TGetTableTypesResp)that);
    }
    
    public boolean equals(final TGetTableTypesResp that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TGetTableTypesResp other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TGetTableTypesResp typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TGetTableTypesResp.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TGetTableTypesResp.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TGetTableTypesResp(");
        boolean first = true;
        sb.append("status:");
        if (this.status == null) {
            sb.append("null");
    ...
    static {
        STRUCT_DESC = new TStruct("TGetTableTypesResp");
        ...
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TGetTableTypesRespStandardSchemeFactory());
        TGetTableTypesResp.schemes.put(TupleScheme.class, new TGetTableTypesRespTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TGetTableTypesResp.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TGetTableTypesResp struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TGetTableTypesResp struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TGetTableTypesResp struct) throws TException {
        ...
        @Override
        public void read(final TProtocol prot, final TGetTableTypesResp struct) throws TException {
