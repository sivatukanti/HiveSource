...
public class TGetCatalogsReq implements TBase<TGetCatalogsReq, _Fields>, Serializable, Cloneable
{
    ...
    public TGetCatalogsReq(final TSessionHandle sessionHandle) {
        this();
        this.sessionHandle = sessionHandle;
    }
    
    public TGetCatalogsReq(final TGetCatalogsReq other) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TGetCatalogsReq && this.equals((TGetCatalogsReq)that);
    }
    
    public boolean equals(final TGetCatalogsReq that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TGetCatalogsReq other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TGetCatalogsReq typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TGetCatalogsReq.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TGetCatalogsReq.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TGetCatalogsReq(");
        boolean first = true;
    ...
    static {
        STRUCT_DESC = new TStruct("TGetCatalogsReq");
        SESSION_HANDLE_FIELD_DESC = new TField("sessionHandle", (byte)12, (short)1);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TGetCatalogsReqStandardSchemeFactory());
        TGetCatalogsReq.schemes.put(TupleScheme.class, new TGetCatalogsReqTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TGetCatalogsReq.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TGetCatalogsReq struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TGetCatalogsReq struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TGetCatalogsReq struct) throws TException {
            final TTupleProtocol oprot = (TTupleProtocol)prot;
            struct.sessionHandle.write(oprot);
        }
        
        @Override
        public void read(final TProtocol prot, final TGetCatalogsReq struct) throws TException {
