...
public class TGetFunctionsResp implements TBase<TGetFunctionsResp, _Fields>, Serializable, Cloneable
{
    ...
    public TGetFunctionsResp(final TStatus status) {
        this();
        this.status = status;
    }
    
    public TGetFunctionsResp(final TGetFunctionsResp other) {
        this.optionals = new _Fields[] { _Fields.OPERATION_HANDLE };
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TGetFunctionsResp && this.equals((TGetFunctionsResp)that);
    }
    
    public boolean equals(final TGetFunctionsResp that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TGetFunctionsResp other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TGetFunctionsResp typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TGetFunctionsResp.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TGetFunctionsResp.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TGetFunctionsResp(");
        boolean first = true;
        sb.append("status:");
        if (this.status == null) {
            sb.append("null");
    ...
    static {
        STRUCT_DESC = new TStruct("TGetFunctionsResp");
        ...
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TGetFunctionsRespStandardSchemeFactory());
        TGetFunctionsResp.schemes.put(TupleScheme.class, new TGetFunctionsRespTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TGetFunctionsResp.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TGetFunctionsResp struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TGetFunctionsResp struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TGetFunctionsResp struct) throws TException {
        ...
        @Override
        public void read(final TProtocol prot, final TGetFunctionsResp struct) throws TException {
