...
public class TBinaryColumn implements TBase<TBinaryColumn, _Fields>, Serializable, Cloneable
{
    ...
    public TBinaryColumn(final List<ByteBuffer> values, final ByteBuffer nulls) {
        this();
        this.values = values;
        this.nulls = nulls;
    }
    
    public TBinaryColumn(final TBinaryColumn other) {
        if (other.isSetValues()) {
            final List<ByteBuffer> __this__values = new ArrayList<ByteBuffer>();
            for (final ByteBuffer other_element : other.values) {
                final ByteBuffer temp_binary_element = TBaseHelper.copyBinary(other_element);
    ...
    public void addToValues(final ByteBuffer elem) {
        if (this.values == null) {
    ...
    public void setValues(final List<ByteBuffer> values) {
        this.values = values;
    }
    ...
    public void setFieldValue(final _Fields field, final Object value) {
        switch (field) {
            case VALUES: {
                ...
                this.setValues((List<ByteBuffer>)value);
                break;
            }
            case NULLS: {
                if (value == null) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TBinaryColumn && this.equals((TBinaryColumn)that);
    }
    
    public boolean equals(final TBinaryColumn that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TBinaryColumn other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TBinaryColumn typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TBinaryColumn.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TBinaryColumn.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TBinaryColumn(");
        boolean first = true;
        sb.append("values:");
        if (this.values == null) {
            sb.append("null");
    ...
    static {
        STRUCT_DESC = new TStruct("TBinaryColumn");
        VALUES_FIELD_DESC = new TField("values", (byte)15, (short)1);
        NULLS_FIELD_DESC = new TField("nulls", (byte)11, (short)2);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TBinaryColumnStandardSchemeFactory());
        TBinaryColumn.schemes.put(TupleScheme.class, new TBinaryColumnTupleSchemeFactory());
        final Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
        tmpMap.put(_Fields.VALUES, new FieldMetaData("values", (byte)1, new ListMetaData((byte)15, new FieldValueMetaData((byte)11, true))));
        tmpMap.put(_Fields.NULLS, new FieldMetaData("nulls", (byte)1, new FieldValueMetaData((byte)11, true)));
        FieldMetaData.addStructMetaDataMap(TBinaryColumn.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TBinaryColumn struct) throws TException {
                ...
                switch (schemeField.id) {
                    case 1: {
                        if (schemeField.type == 15) {
                            final TList _list110 = iprot.readListBegin();
                            struct.values = (List<ByteBuffer>)new ArrayList(_list110.size);
                            for (int _i111 = 0; _i111 < _list110.size; ++_i111) {
                                final ByteBuffer _elem112 = iprot.readBinary();
        ...
        @Override
        public void write(final TProtocol oprot, final TBinaryColumn struct) throws TException {
            struct.validate();
            ...
            if (struct.values != null) {
                ...
                for (final ByteBuffer _iter113 : struct.values) {
    ...
    {
        @Override
        public void write(final TProtocol prot, final TBinaryColumn struct) throws TException {
            final TTupleProtocol oprot = (TTupleProtocol)prot;
            oprot.writeI32(struct.values.size());
            for (final ByteBuffer _iter114 : struct.values) {
        ...
        @Override
        public void read(final TProtocol prot, final TBinaryColumn struct) throws TException {
            final TTupleProtocol iprot = (TTupleProtocol)prot;
            final TList _list115 = new TList((byte)11, iprot.readI32());
            struct.values = (List<ByteBuffer>)new ArrayList(_list115.size);
            for (int _i116 = 0; _i116 < _list115.size; ++_i116) {
                final ByteBuffer _elem117 = iprot.readBinary();
