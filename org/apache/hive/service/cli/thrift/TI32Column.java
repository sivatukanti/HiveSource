...
public class TI32Column implements TBase<TI32Column, _Fields>, Serializable, Cloneable
{
    ...
    public TI32Column(final List<Integer> values, final ByteBuffer nulls) {
        this();
        this.values = values;
        this.nulls = nulls;
    }
    
    public TI32Column(final TI32Column other) {
        if (other.isSetValues()) {
            final List<Integer> __this__values = new ArrayList<Integer>();
            for (final Integer other_element : other.values) {
    ...
    public void addToValues(final int elem) {
        if (this.values == null) {
    ...
    public void setFieldValue(final _Fields field, final Object value) {
        switch (field) {
            case VALUES: {
                ...
                this.setValues((List<Integer>)value);
                break;
            }
            case NULLS: {
                if (value == null) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TI32Column && this.equals((TI32Column)that);
    }
    
    public boolean equals(final TI32Column that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TI32Column other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TI32Column typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TI32Column.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TI32Column.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TI32Column(");
        boolean first = true;
        sb.append("values:");
        if (this.values == null) {
            sb.append("null");
    ...
    static {
        STRUCT_DESC = new TStruct("TI32Column");
        VALUES_FIELD_DESC = new TField("values", (byte)15, (short)1);
        NULLS_FIELD_DESC = new TField("nulls", (byte)11, (short)2);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TI32ColumnStandardSchemeFactory());
        TI32Column.schemes.put(TupleScheme.class, new TI32ColumnTupleSchemeFactory());
        final Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
        tmpMap.put(_Fields.VALUES, new FieldMetaData("values", (byte)1, new ListMetaData((byte)15, new FieldValueMetaData((byte)8))));
        tmpMap.put(_Fields.NULLS, new FieldMetaData("nulls", (byte)1, new FieldValueMetaData((byte)11, true)));
        FieldMetaData.addStructMetaDataMap(TI32Column.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TI32Column struct) throws TException {
                ...
                switch (schemeField.id) {
                    case 1: {
                        if (schemeField.type == 15) {
                            ...
                            struct.values = (List<Integer>)new ArrayList(_list78.size);
                            for (int _i79 = 0; _i79 < _list78.size; ++_i79) {
                                final int _elem80 = iprot.readI32();
        ...
        @Override
        public void write(final TProtocol oprot, final TI32Column struct) throws TException {
            struct.validate();
            ...
            if (struct.values != null) {
                ...
                for (final int _iter81 : struct.values) {
    ...
    {
        @Override
        public void write(final TProtocol prot, final TI32Column struct) throws TException {
            final TTupleProtocol oprot = (TTupleProtocol)prot;
            oprot.writeI32(struct.values.size());
            for (final int _iter82 : struct.values) {
        ...
        @Override
        public void read(final TProtocol prot, final TI32Column struct) throws TException {
            final TTupleProtocol iprot = (TTupleProtocol)prot;
            final TList _list83 = new TList((byte)8, iprot.readI32());
            struct.values = (List<Integer>)new ArrayList(_list83.size);
            for (int _i84 = 0; _i84 < _list83.size; ++_i84) {
                final int _elem85 = iprot.readI32();
