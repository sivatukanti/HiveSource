...
public class TGetTableTypesReq implements TBase<TGetTableTypesReq, _Fields>, Serializable, Cloneable
{
    ...
    public TGetTableTypesReq(final TSessionHandle sessionHandle) {
        this();
        this.sessionHandle = sessionHandle;
    }
    
    public TGetTableTypesReq(final TGetTableTypesReq other) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof TGetTableTypesReq && this.equals((TGetTableTypesReq)that);
    }
    
    public boolean equals(final TGetTableTypesReq that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final TGetTableTypesReq other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final TGetTableTypesReq typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        TGetTableTypesReq.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        TGetTableTypesReq.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("TGetTableTypesReq(");
        boolean first = true;
    ...
    static {
        STRUCT_DESC = new TStruct("TGetTableTypesReq");
        SESSION_HANDLE_FIELD_DESC = new TField("sessionHandle", (byte)12, (short)1);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new TGetTableTypesReqStandardSchemeFactory());
        TGetTableTypesReq.schemes.put(TupleScheme.class, new TGetTableTypesReqTupleSchemeFactory());
        ...
        FieldMetaData.addStructMetaDataMap(TGetTableTypesReq.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final TGetTableTypesReq struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final TGetTableTypesReq struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final TGetTableTypesReq struct) throws TException {
            final TTupleProtocol oprot = (TTupleProtocol)prot;
            struct.sessionHandle.write(oprot);
        }
        
        @Override
        public void read(final TProtocol prot, final TGetTableTypesReq struct) throws TException {
