...
public enum GetInfoType
{
    ...
    private GetInfoType(final TGetInfoType tInfoType) {
        this.tInfoType = tInfoType;
    }
    
    public static GetInfoType getGetInfoType(final TGetInfoType tGetInfoType) {
        for (final GetInfoType infoType : values()) {
