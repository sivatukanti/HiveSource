...
public class VerGen
{
    ...
    public static void generateFile(final File outputDir, final Version version, final String rev, final String buildDate) throws IOException {
        final String path = "org.apache.zookeeper.version".replaceAll("\\.", "/");
        final File pkgdir = new File(outputDir, path);
        if (!pkgdir.exists()) {
            final boolean ret = pkgdir.mkdirs();
            if (!ret) {
        ...
        final File file = new File(pkgdir, "Info.java");
        FileWriter w = null;
        try {
    ...
    public static Version parseVersionString(final String input) {
    ...
    public static void main(final String[] args) {
        ...
        try {
            final Version version = parseVersionString(args[0]);
            if (version == null) {
