...
public class Stat implements Record
{
    ...
    public Stat(final long czxid, final long mzxid, final long ctime, final long mtime, final int version, final int cversion, final int aversion, final long ephemeralOwner, final int dataLength, final int numChildren, final long pzxid) {
        this.czxid = czxid;
        this.mzxid = mzxid;
        this.ctime = ctime;
        this.mtime = mtime;
    ...
    public void setDataLength(final int m_) {
        this.dataLength = m_;
    }
    ...
    public void setNumChildren(final int m_) {
        this.numChildren = m_;
    }
    ...
    public void setPzxid(final long m_) {
        this.pzxid = m_;
    }
    ...
    public int hashCode() {
        ...
        result = 37 * result + ret;
        ret = (int)(this.pzxid ^ this.pzxid >>> 32);
        result = 37 * result + ret;
        return result;
    }
