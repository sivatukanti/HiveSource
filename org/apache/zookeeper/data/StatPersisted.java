...
public class StatPersisted implements Record
{
    ...
    public StatPersisted(final long czxid, final long mzxid, final long ctime, final long mtime, final int version, final int cversion, final int aversion, final long ephemeralOwner, final long pzxid) {
        this.czxid = czxid;
        this.mzxid = mzxid;
        this.ctime = ctime;
        this.mtime = mtime;
    ...
    public int compareTo(final Object peer_) throws ClassCastException {
        ...
        final StatPersisted peer = (StatPersisted)peer_;
        int ret = 0;
