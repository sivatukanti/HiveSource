...
public class KMSRESTConstants
{
    ...
    public static final String KEYS_METADATA_RESOURCE = "keys/metadata";
    public static final String KEYS_NAMES_RESOURCE = "keys/names";
    ...
    public static final String ENCRYPTED_KEY_VERSION_FIELD = "encryptedKeyVersion";
