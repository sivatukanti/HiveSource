...
public class GetContainerStatusesRequestPBImpl extends GetContainerStatusesRequest
{
    YarnServiceProtos.GetContainerStatusesRequestProto proto;
    YarnServiceProtos.GetContainerStatusesRequestProto.Builder builder;
    boolean viaProto;
    private List<ContainerId> containerIds;
    
    public GetContainerStatusesRequestPBImpl() {
        this.proto = YarnServiceProtos.GetContainerStatusesRequestProto.getDefaultInstance();
        this.builder = null;
        this.viaProto = false;
    ...
    public GetContainerStatusesRequestPBImpl(final YarnServiceProtos.GetContainerStatusesRequestProto proto) {
        this.proto = YarnServiceProtos.GetContainerStatusesRequestProto.getDefaultInstance();
        this.builder = null;
        this.viaProto = false;
        this.containerIds = null;
    ...
    public boolean equals(final Object other) {
        return other != null && other.getClass().isAssignableFrom(this.getClass()) && this.getProto().equals(((GetContainerStatusesRequestPBImpl)this.getClass().cast(other)).getProto());
    }
    ...
    private void initLocalContainerIds() {
        ...
        final YarnServiceProtos.GetContainerStatusesRequestProtoOrBuilder p = this.viaProto ? this.proto : this.builder;
