...
public class ReservationDeleteRequestPBImpl extends ReservationDeleteRequest
{
    ...
    public ReservationDeleteRequestPBImpl(final YarnServiceProtos.ReservationDeleteRequestProto proto) {
        this.proto = YarnServiceProtos.ReservationDeleteRequestProto.getDefaultInstance();
        this.builder = null;
        this.viaProto = false;
        this.proto = proto;
    ...
    public ReservationId getReservationId() {
        final YarnServiceProtos.ReservationDeleteRequestProtoOrBuilder p = this.viaProto ? this.proto : this.builder;
        if (this.reservationId != null) {
    ...
    public boolean equals(final Object other) {
        return other != null && other.getClass().isAssignableFrom(this.getClass()) && this.getProto().equals(((ReservationDeleteRequestPBImpl)this.getClass().cast(other)).getProto());
    }
