...
{
    YarnProtos.ContainerResourceDecreaseProto proto;
    YarnProtos.ContainerResourceDecreaseProto.Builder builder;
    boolean viaProto;
    private ContainerId existingContainerId;
    private Resource targetCapability;
    
    public ContainerResourceDecreasePBImpl() {
        this.proto = YarnProtos.ContainerResourceDecreaseProto.getDefaultInstance();
        this.builder = null;
        this.viaProto = false;
        this.existingContainerId = null;
        this.targetCapability = null;
        this.builder = YarnProtos.ContainerResourceDecreaseProto.newBuilder();
    }
    
    public ContainerResourceDecreasePBImpl(final YarnProtos.ContainerResourceDecreaseProto proto) {
        this.proto = YarnProtos.ContainerResourceDecreaseProto.getDefaultInstance();
        this.builder = null;
        this.viaProto = false;
        this.existingContainerId = null;
    ...
    public YarnProtos.ContainerResourceDecreaseProto getProto() {
    ...
    public ContainerId getContainerId() {
        final YarnProtos.ContainerResourceDecreaseProtoOrBuilder p = this.viaProto ? this.proto : this.builder;
    ...
    private void maybeInitBuilder() {
        if (this.viaProto || this.builder == null) {
            this.builder = YarnProtos.ContainerResourceDecreaseProto.newBuilder(this.proto);
        }
        this.viaProto = false;
    }
