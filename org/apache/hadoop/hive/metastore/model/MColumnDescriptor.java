...
public class MColumnDescriptor implements Detachable, PersistenceCapable
{
    ...
    public MColumnDescriptor(final List<MFieldSchema> cols) {
        this.cols = cols;
    }
    
    public List<MFieldSchema> getCols() {
        return (List<MFieldSchema>)jdoGetcols(this);
    }
    
    public void setCols(final List<MFieldSchema> cols) {
        jdoSetcols(this, cols);
    }
    ...
    static {
        ...
        JDOImplHelper.registerClass(___jdo$loadClass("org.apache.hadoop.hive.metastore.model.MColumnDescriptor"), MColumnDescriptor.jdoFieldNames, MColumnDescriptor.jdoFieldTypes, MColumnDescriptor.jdoFieldFlags, MColumnDescriptor.jdoPersistenceCapableSuperclass, new MColumnDescriptor());
    }
    ...
    public void jdoMakeDirty(final String fieldName) {
        ...
        if (this.jdoIsDetached() && fieldName != null) {
            ...
            int i = 0;
            while (i < MColumnDescriptor.jdoFieldNames.length) {
                if (MColumnDescriptor.jdoFieldNames[i].equals(fldName)) {
                    if (((BitSet)this.jdoDetachedState[2]).get(i + MColumnDescriptor.jdoInheritedFieldCount)) {
                        ((BitSet)this.jdoDetachedState[3]).set(i + MColumnDescriptor.jdoInheritedFieldCount);
                        return;
                    }
    ...
    public PersistenceCapable jdoNewInstance(final StateManager sm) {
        final MColumnDescriptor result = new MColumnDescriptor();
        result.jdoFlags = 1;
    ...
    public void jdoReplaceField(final int index) {
        ...
        switch (index) {
            case 0: {
                this.cols = (List<MFieldSchema>)this.jdoStateManager.replacingObjectField(this, index);
            }
            default: {
    ...
    public void jdoProvideField(final int index) {
        ...
        switch (index) {
            case 0: {
                this.jdoStateManager.providedObjectField(this, index, this.cols);
            }
            default: {
                throw new IllegalArgumentException(new StringBuffer("out of field index :").append(index).toString());
            }
    ...
    protected final void jdoCopyField(final MColumnDescriptor obj, final int index) {
        switch (index) {
            case 0: {
                this.cols = obj.cols;
            }
    ...
    public void jdoCopyFields(final Object obj, final int[] indices) {
        ...
        final MColumnDescriptor other = (MColumnDescriptor)obj;
    ...
    private static final Class[] __jdoFieldTypesInit() {
        return new Class[] { ___jdo$loadClass("java.util.List") };
    }
    ...
    private Object jdoSuperClone() throws CloneNotSupportedException {
        final MColumnDescriptor o = (MColumnDescriptor)super.clone();
        o.jdoFlags = 0;
        o.jdoStateManager = null;
        return o;
    }
    
    private static List jdoGetcols(final MColumnDescriptor objPC) {
        if (objPC.jdoStateManager != null && !objPC.jdoStateManager.isLoaded(objPC, 0)) {
            return (List)objPC.jdoStateManager.getObjectField(objPC, 0, objPC.cols);
        }
    ...
    private static void jdoSetcols(final MColumnDescriptor objPC, final List val) {
        if (objPC.jdoStateManager == null) {
            objPC.cols = (List<MFieldSchema>)val;
        }
        else {
            objPC.jdoStateManager.setObjectField(objPC, 0, objPC.cols, val);
        }
