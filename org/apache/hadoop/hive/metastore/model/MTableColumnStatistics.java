...
public class MTableColumnStatistics implements Detachable, PersistenceCapable
{
    ...
    static {
        ...
        JDOImplHelper.registerClass(___jdo$loadClass("org.apache.hadoop.hive.metastore.model.MTableColumnStatistics"), MTableColumnStatistics.jdoFieldNames, MTableColumnStatistics.jdoFieldTypes, MTableColumnStatistics.jdoFieldFlags, MTableColumnStatistics.jdoPersistenceCapableSuperclass, new MTableColumnStatistics());
    }
    ...
    public void jdoMakeDirty(final String fieldName) {
        ...
        if (this.jdoIsDetached() && fieldName != null) {
            ...
            int i = 0;
            while (i < MTableColumnStatistics.jdoFieldNames.length) {
                if (MTableColumnStatistics.jdoFieldNames[i].equals(fldName)) {
                    if (((BitSet)this.jdoDetachedState[2]).get(i + MTableColumnStatistics.jdoInheritedFieldCount)) {
                        ((BitSet)this.jdoDetachedState[3]).set(i + MTableColumnStatistics.jdoInheritedFieldCount);
                        return;
                    }
    ...
    public PersistenceCapable jdoNewInstance(final StateManager sm) {
        final MTableColumnStatistics result = new MTableColumnStatistics();
        result.jdoFlags = 1;
    ...
    protected final void jdoCopyField(final MTableColumnStatistics obj, final int index) {
        switch (index) {
            case 0: {
    ...
    public void jdoCopyFields(final Object obj, final int[] indices) {
        ...
        if (!(obj instanceof MTableColumnStatistics)) {
        ...
        final MTableColumnStatistics other = (MTableColumnStatistics)obj;
    ...
    private Object jdoSuperClone() throws CloneNotSupportedException {
        final MTableColumnStatistics o = (MTableColumnStatistics)super.clone();
        o.jdoFlags = 0;
        o.jdoStateManager = null;
        return o;
    }
    
    private static Double jdoGetavgColLen(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetavgColLen(final MTableColumnStatistics objPC, final Double val) {
    ...
    private static String jdoGetcolName(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetcolName(final MTableColumnStatistics objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetcolType(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetcolType(final MTableColumnStatistics objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetdbName(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetdbName(final MTableColumnStatistics objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetdecimalHighValue(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetdecimalHighValue(final MTableColumnStatistics objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetdecimalLowValue(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetdecimalLowValue(final MTableColumnStatistics objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static Double jdoGetdoubleHighValue(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetdoubleHighValue(final MTableColumnStatistics objPC, final Double val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static Double jdoGetdoubleLowValue(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetdoubleLowValue(final MTableColumnStatistics objPC, final Double val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static long jdoGetlastAnalyzed(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetlastAnalyzed(final MTableColumnStatistics objPC, final long val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static Long jdoGetlongHighValue(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetlongHighValue(final MTableColumnStatistics objPC, final Long val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static Long jdoGetlongLowValue(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetlongLowValue(final MTableColumnStatistics objPC, final Long val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static Long jdoGetmaxColLen(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetmaxColLen(final MTableColumnStatistics objPC, final Long val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static Long jdoGetnumDVs(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetnumDVs(final MTableColumnStatistics objPC, final Long val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static Long jdoGetnumFalses(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetnumFalses(final MTableColumnStatistics objPC, final Long val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static Long jdoGetnumNulls(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetnumNulls(final MTableColumnStatistics objPC, final Long val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static Long jdoGetnumTrues(final MTableColumnStatistics objPC) {
    ...
    private static void jdoSetnumTrues(final MTableColumnStatistics objPC, final Long val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static MTable jdoGettable(final MTableColumnStatistics objPC) {
        if (objPC.jdoStateManager != null && !objPC.jdoStateManager.isLoaded(objPC, 16)) {
            return (MTable)objPC.jdoStateManager.getObjectField(objPC, 16, objPC.table);
        }
    ...
    private static void jdoSettable(final MTableColumnStatistics objPC, final MTable val) {
        if (objPC.jdoStateManager == null) {
            objPC.table = val;
        }
        else {
            objPC.jdoStateManager.setObjectField(objPC, 16, objPC.table, val);
        }
        if (objPC.jdoIsDetached()) {
    ...
    private static String jdoGettableName(final MTableColumnStatistics objPC) {
        if (objPC.jdoFlags > 0 && objPC.jdoStateManager != null && !objPC.jdoStateManager.isLoaded(objPC, 17)) {
            return objPC.jdoStateManager.getStringField(objPC, 17, objPC.tableName);
        }
    ...
    private static void jdoSettableName(final MTableColumnStatistics objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
            objPC.jdoStateManager.setStringField(objPC, 17, objPC.tableName, val);
        }
        else {
            objPC.tableName = val;
            if (objPC.jdoIsDetached()) {
