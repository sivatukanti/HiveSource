...
public class MTablePrivilege implements Detachable, PersistenceCapable
{
    ...
    public MTablePrivilege(final String principalName, final String principalType, final MTable table, final String privilege, final int createTime, final String grantor, final String grantorType, final boolean grantOption) {
    ...
    static {
        ...
        JDOImplHelper.registerClass(___jdo$loadClass("org.apache.hadoop.hive.metastore.model.MTablePrivilege"), MTablePrivilege.jdoFieldNames, MTablePrivilege.jdoFieldTypes, MTablePrivilege.jdoFieldFlags, MTablePrivilege.jdoPersistenceCapableSuperclass, new MTablePrivilege());
    }
    ...
    public void jdoMakeDirty(final String fieldName) {
        ...
        if (this.jdoIsDetached() && fieldName != null) {
            ...
            int i = 0;
            while (i < MTablePrivilege.jdoFieldNames.length) {
                if (MTablePrivilege.jdoFieldNames[i].equals(fldName)) {
                    if (((BitSet)this.jdoDetachedState[2]).get(i + MTablePrivilege.jdoInheritedFieldCount)) {
                        ((BitSet)this.jdoDetachedState[3]).set(i + MTablePrivilege.jdoInheritedFieldCount);
                        return;
                    }
    ...
    public PersistenceCapable jdoNewInstance(final StateManager sm) {
        final MTablePrivilege result = new MTablePrivilege();
        result.jdoFlags = 1;
    ...
    protected final void jdoCopyField(final MTablePrivilege obj, final int index) {
        switch (index) {
            case 0: {
    ...
    public void jdoCopyFields(final Object obj, final int[] indices) {
        ...
        if (!(obj instanceof MTablePrivilege)) {
        ...
        final MTablePrivilege other = (MTablePrivilege)obj;
    ...
    private static final Class[] __jdoFieldTypesInit() {
        return new Class[] { Integer.TYPE, Boolean.TYPE, ___jdo$loadClass("java.lang.String"), ___jdo$loadClass("java.lang.String"), ___jdo$loadClass("java.lang.String"), ___jdo$loadClass("java.lang.String"), ___jdo$loadClass("java.lang.String"), ___jdo$loadClass("org.apache.hadoop.hive.metastore.model.MTable") };
    }
    ...
    private Object jdoSuperClone() throws CloneNotSupportedException {
        final MTablePrivilege o = (MTablePrivilege)super.clone();
        o.jdoFlags = 0;
        o.jdoStateManager = null;
        return o;
    }
    
    private static int jdoGetcreateTime(final MTablePrivilege objPC) {
    ...
    private static void jdoSetcreateTime(final MTablePrivilege objPC, final int val) {
    ...
    private static boolean jdoGetgrantOption(final MTablePrivilege objPC) {
    ...
    private static void jdoSetgrantOption(final MTablePrivilege objPC, final boolean val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetgrantor(final MTablePrivilege objPC) {
    ...
    private static void jdoSetgrantor(final MTablePrivilege objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetgrantorType(final MTablePrivilege objPC) {
    ...
    private static void jdoSetgrantorType(final MTablePrivilege objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetprincipalName(final MTablePrivilege objPC) {
    ...
    private static void jdoSetprincipalName(final MTablePrivilege objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetprincipalType(final MTablePrivilege objPC) {
    ...
    private static void jdoSetprincipalType(final MTablePrivilege objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetprivilege(final MTablePrivilege objPC) {
    ...
    private static void jdoSetprivilege(final MTablePrivilege objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static MTable jdoGettable(final MTablePrivilege objPC) {
        if (objPC.jdoStateManager != null && !objPC.jdoStateManager.isLoaded(objPC, 7)) {
            return (MTable)objPC.jdoStateManager.getObjectField(objPC, 7, objPC.table);
        }
    ...
    private static void jdoSettable(final MTablePrivilege objPC, final MTable val) {
        if (objPC.jdoStateManager == null) {
            objPC.table = val;
        }
        else {
            objPC.jdoStateManager.setObjectField(objPC, 7, objPC.table, val);
        }
        if (objPC.jdoIsDetached()) {
