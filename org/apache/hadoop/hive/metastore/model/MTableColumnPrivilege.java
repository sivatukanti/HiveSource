...
public class MTableColumnPrivilege implements Detachable, PersistenceCapable
{
    ...
    public MTableColumnPrivilege(final String principalName, final String principalType, final MTable table, final String columnName, final String privileges, final int createTime, final String grantor, final String grantorType, final boolean grantOption) {
    ...
    static {
        ...
        JDOImplHelper.registerClass(___jdo$loadClass("org.apache.hadoop.hive.metastore.model.MTableColumnPrivilege"), MTableColumnPrivilege.jdoFieldNames, MTableColumnPrivilege.jdoFieldTypes, MTableColumnPrivilege.jdoFieldFlags, MTableColumnPrivilege.jdoPersistenceCapableSuperclass, new MTableColumnPrivilege());
    }
    ...
    public void jdoMakeDirty(final String fieldName) {
        ...
        if (this.jdoIsDetached() && fieldName != null) {
            ...
            int i = 0;
            while (i < MTableColumnPrivilege.jdoFieldNames.length) {
                if (MTableColumnPrivilege.jdoFieldNames[i].equals(fldName)) {
                    if (((BitSet)this.jdoDetachedState[2]).get(i + MTableColumnPrivilege.jdoInheritedFieldCount)) {
                        ((BitSet)this.jdoDetachedState[3]).set(i + MTableColumnPrivilege.jdoInheritedFieldCount);
                        return;
                    }
    ...
    public PersistenceCapable jdoNewInstance(final StateManager sm) {
        final MTableColumnPrivilege result = new MTableColumnPrivilege();
        result.jdoFlags = 1;
    ...
    protected final void jdoCopyField(final MTableColumnPrivilege obj, final int index) {
        switch (index) {
            case 0: {
    ...
    public void jdoCopyFields(final Object obj, final int[] indices) {
        ...
        if (!(obj instanceof MTableColumnPrivilege)) {
        ...
        final MTableColumnPrivilege other = (MTableColumnPrivilege)obj;
    ...
    private static final Class[] __jdoFieldTypesInit() {
        return new Class[] { ___jdo$loadClass("java.lang.String"), Integer.TYPE, Boolean.TYPE, ___jdo$loadClass("java.lang.String"), ___jdo$loadClass("java.lang.String"), ___jdo$loadClass("java.lang.String"), ___jdo$loadClass("java.lang.String"), ___jdo$loadClass("java.lang.String"), ___jdo$loadClass("org.apache.hadoop.hive.metastore.model.MTable") };
    }
    ...
    private Object jdoSuperClone() throws CloneNotSupportedException {
        final MTableColumnPrivilege o = (MTableColumnPrivilege)super.clone();
        o.jdoFlags = 0;
        o.jdoStateManager = null;
        return o;
    }
    
    private static String jdoGetcolumnName(final MTableColumnPrivilege objPC) {
    ...
    private static void jdoSetcolumnName(final MTableColumnPrivilege objPC, final String val) {
    ...
    private static int jdoGetcreateTime(final MTableColumnPrivilege objPC) {
    ...
    private static void jdoSetcreateTime(final MTableColumnPrivilege objPC, final int val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static boolean jdoGetgrantOption(final MTableColumnPrivilege objPC) {
    ...
    private static void jdoSetgrantOption(final MTableColumnPrivilege objPC, final boolean val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetgrantor(final MTableColumnPrivilege objPC) {
    ...
    private static void jdoSetgrantor(final MTableColumnPrivilege objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetgrantorType(final MTableColumnPrivilege objPC) {
    ...
    private static void jdoSetgrantorType(final MTableColumnPrivilege objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetprincipalName(final MTableColumnPrivilege objPC) {
    ...
    private static void jdoSetprincipalName(final MTableColumnPrivilege objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetprincipalType(final MTableColumnPrivilege objPC) {
    ...
    private static void jdoSetprincipalType(final MTableColumnPrivilege objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static String jdoGetprivilege(final MTableColumnPrivilege objPC) {
    ...
    private static void jdoSetprivilege(final MTableColumnPrivilege objPC, final String val) {
        if (objPC.jdoFlags != 0 && objPC.jdoStateManager != null) {
    ...
    private static MTable jdoGettable(final MTableColumnPrivilege objPC) {
        if (objPC.jdoStateManager != null && !objPC.jdoStateManager.isLoaded(objPC, 8)) {
            return (MTable)objPC.jdoStateManager.getObjectField(objPC, 8, objPC.table);
        }
    ...
    private static void jdoSettable(final MTableColumnPrivilege objPC, final MTable val) {
        if (objPC.jdoStateManager == null) {
            objPC.table = val;
        }
        else {
            objPC.jdoStateManager.setObjectField(objPC, 8, objPC.table, val);
        }
        if (objPC.jdoIsDetached()) {
