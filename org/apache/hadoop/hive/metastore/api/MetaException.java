...
public class MetaException extends TException implements TBase<MetaException, _Fields>, Serializable, Cloneable
{
    ...
    public MetaException(final MetaException other) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof MetaException && this.equals((MetaException)that);
    }
    
    public boolean equals(final MetaException that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final MetaException other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final MetaException typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        MetaException.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        MetaException.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("MetaException(");
        boolean first = true;
        sb.append("message:");
    ...
    static {
        STRUCT_DESC = new TStruct("MetaException");
        MESSAGE_FIELD_DESC = new TField("message", (byte)11, (short)1);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new MetaExceptionStandardSchemeFactory());
        MetaException.schemes.put(TupleScheme.class, new MetaExceptionTupleSchemeFactory());
        final Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
        tmpMap.put(_Fields.MESSAGE, new FieldMetaData("message", (byte)3, new FieldValueMetaData((byte)11)));
        FieldMetaData.addStructMetaDataMap(MetaException.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final MetaException struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final MetaException struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final MetaException struct) throws TException {
        ...
        @Override
        public void read(final TProtocol prot, final MetaException struct) throws TException {
