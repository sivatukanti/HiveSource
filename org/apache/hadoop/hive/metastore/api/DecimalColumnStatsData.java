...
public class DecimalColumnStatsData implements TBase<DecimalColumnStatsData, _Fields>, Serializable, Cloneable
{
    ...
    public DecimalColumnStatsData(final long numNulls, final long numDVs) {
        this();
    ...
    public DecimalColumnStatsData(final DecimalColumnStatsData other) {
        this.__isset_bitfield = 0;
        this.optionals = new _Fields[] { _Fields.LOW_VALUE, _Fields.HIGH_VALUE };
    ...
    public void setLowValue(final Decimal lowValue) {
    ...
    public void setHighValue(final Decimal highValue) {
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof DecimalColumnStatsData && this.equals((DecimalColumnStatsData)that);
    }
    
    public boolean equals(final DecimalColumnStatsData that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final DecimalColumnStatsData other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final DecimalColumnStatsData typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        DecimalColumnStatsData.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        DecimalColumnStatsData.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("DecimalColumnStatsData(");
        boolean first = true;
        if (this.isSetLowValue()) {
            sb.append("lowValue:");
    ...
    static {
        STRUCT_DESC = new TStruct("DecimalColumnStatsData");
        ...
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new DecimalColumnStatsDataStandardSchemeFactory());
        DecimalColumnStatsData.schemes.put(TupleScheme.class, new DecimalColumnStatsDataTupleSchemeFactory());
        final Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
        tmpMap.put(_Fields.LOW_VALUE, new FieldMetaData("lowValue", (byte)2, new StructMetaData((byte)12, Decimal.class)));
        tmpMap.put(_Fields.HIGH_VALUE, new FieldMetaData("highValue", (byte)2, new StructMetaData((byte)12, Decimal.class)));
        ...
        FieldMetaData.addStructMetaDataMap(DecimalColumnStatsData.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final DecimalColumnStatsData struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final DecimalColumnStatsData struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final DecimalColumnStatsData struct) throws TException {
        ...
        @Override
        public void read(final TProtocol prot, final DecimalColumnStatsData struct) throws TException {
