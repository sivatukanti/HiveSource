...
public class CheckLockRequest implements TBase<CheckLockRequest, _Fields>, Serializable, Cloneable
{
    ...
    public CheckLockRequest(final long lockid) {
        this();
        this.lockid = lockid;
        this.setLockidIsSet(true);
    }
    
    public CheckLockRequest(final CheckLockRequest other) {
        this.__isset_bitfield = 0;
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof CheckLockRequest && this.equals((CheckLockRequest)that);
    }
    
    public boolean equals(final CheckLockRequest that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final CheckLockRequest other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final CheckLockRequest typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        CheckLockRequest.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        CheckLockRequest.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("CheckLockRequest(");
        boolean first = true;
        sb.append("lockid:");
    ...
    static {
        STRUCT_DESC = new TStruct("CheckLockRequest");
        LOCKID_FIELD_DESC = new TField("lockid", (byte)10, (short)1);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new CheckLockRequestStandardSchemeFactory());
        CheckLockRequest.schemes.put(TupleScheme.class, new CheckLockRequestTupleSchemeFactory());
        final Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
        tmpMap.put(_Fields.LOCKID, new FieldMetaData("lockid", (byte)1, new FieldValueMetaData((byte)10)));
        FieldMetaData.addStructMetaDataMap(CheckLockRequest.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final CheckLockRequest struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final CheckLockRequest struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final CheckLockRequest struct) throws TException {
            final TTupleProtocol oprot = (TTupleProtocol)prot;
            oprot.writeI64(struct.lockid);
        }
        
        @Override
        public void read(final TProtocol prot, final CheckLockRequest struct) throws TException {
