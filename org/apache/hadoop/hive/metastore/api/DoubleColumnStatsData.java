...
public class DoubleColumnStatsData implements TBase<DoubleColumnStatsData, _Fields>, Serializable, Cloneable
{
    ...
    public DoubleColumnStatsData(final long numNulls, final long numDVs) {
        this();
    ...
    public DoubleColumnStatsData(final DoubleColumnStatsData other) {
        this.__isset_bitfield = 0;
        this.optionals = new _Fields[] { _Fields.LOW_VALUE, _Fields.HIGH_VALUE };
    ...
    public boolean equals(final Object that) {
        return that != null && that instanceof DoubleColumnStatsData && this.equals((DoubleColumnStatsData)that);
    }
    
    public boolean equals(final DoubleColumnStatsData that) {
        if (that == null) {
            return false;
        }
    ...
    @Override
    public int compareTo(final DoubleColumnStatsData other) {
        if (!this.getClass().equals(other.getClass())) {
            return this.getClass().getName().compareTo(other.getClass().getName());
        }
        int lastComparison = 0;
        final DoubleColumnStatsData typedOther = other;
    ...
    public void read(final TProtocol iprot) throws TException {
        DoubleColumnStatsData.schemes.get(iprot.getScheme()).getScheme().read(iprot, this);
    }
    
    @Override
    public void write(final TProtocol oprot) throws TException {
        DoubleColumnStatsData.schemes.get(oprot.getScheme()).getScheme().write(oprot, this);
    }
    
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("DoubleColumnStatsData(");
        boolean first = true;
        if (this.isSetLowValue()) {
            sb.append("lowValue:");
    ...
    static {
        STRUCT_DESC = new TStruct("DoubleColumnStatsData");
        LOW_VALUE_FIELD_DESC = new TField("lowValue", (byte)4, (short)1);
        HIGH_VALUE_FIELD_DESC = new TField("highValue", (byte)4, (short)2);
        NUM_NULLS_FIELD_DESC = new TField("numNulls", (byte)10, (short)3);
        NUM_DVS_FIELD_DESC = new TField("numDVs", (byte)10, (short)4);
        (schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>()).put(StandardScheme.class, new DoubleColumnStatsDataStandardSchemeFactory());
        DoubleColumnStatsData.schemes.put(TupleScheme.class, new DoubleColumnStatsDataTupleSchemeFactory());
        final Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
        tmpMap.put(_Fields.LOW_VALUE, new FieldMetaData("lowValue", (byte)2, new FieldValueMetaData((byte)4)));
        tmpMap.put(_Fields.HIGH_VALUE, new FieldMetaData("highValue", (byte)2, new FieldValueMetaData((byte)4)));
        ...
        FieldMetaData.addStructMetaDataMap(DoubleColumnStatsData.class, metaDataMap = Collections.unmodifiableMap((Map<? extends _Fields, ? extends FieldMetaData>)tmpMap));
    }
    ...
    {
        @Override
        public void read(final TProtocol iprot, final DoubleColumnStatsData struct) throws TException {
        ...
        @Override
        public void write(final TProtocol oprot, final DoubleColumnStatsData struct) throws TException {
            struct.validate();
    ...
    {
        @Override
        public void write(final TProtocol prot, final DoubleColumnStatsData struct) throws TException {
        ...
        @Override
        public void read(final TProtocol prot, final DoubleColumnStatsData struct) throws TException {
