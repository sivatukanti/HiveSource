...
public class RealDeleteResultSetStatistics extends RealNoRowsResultSetStatistics
{
    ...
    public RealDeleteResultSetStatistics(final int rowCount, final boolean deferred, final int indexesUpdated, final boolean tableLock, final long n, final ResultSetStatistics sourceResultSetStatistics) {
