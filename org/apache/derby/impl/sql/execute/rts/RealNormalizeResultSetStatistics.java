...
public class RealNormalizeResultSetStatistics extends RealNoPutResultSetStatistics
{
    ...
    public RealNormalizeResultSetStatistics(final int n, final int n2, final int n3, final long n4, final long n5, final long n6, final long n7, final int n8, final double n9, final double n10, final ResultSetStatistics childResultSetStatistics) {
    ...
    public String getNodeName() {
        return MessageService.getTextMessage("43X91.U");
    }
