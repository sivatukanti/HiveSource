...
public class RealAnyResultSetStatistics extends RealNoPutResultSetStatistics
{
    ...
    public RealAnyResultSetStatistics(final int n, final int n2, final int n3, final long n4, final long n5, final long n6, final long n7, final int n8, final int subqueryNumber, final int pointOfAttachment, final double n9, final double n10, final ResultSetStatistics childResultSetStatistics) {
