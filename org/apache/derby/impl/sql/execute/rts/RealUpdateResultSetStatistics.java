...
public class RealUpdateResultSetStatistics extends RealNoRowsResultSetStatistics
{
    ...
    public RealUpdateResultSetStatistics(final int rowCount, final boolean deferred, final int indexesUpdated, final boolean tableLock, final long n, final ResultSetStatistics sourceResultSetStatistics) {
