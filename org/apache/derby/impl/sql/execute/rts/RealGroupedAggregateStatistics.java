...
public class RealGroupedAggregateStatistics extends RealNoPutResultSetStatistics
{
    ...
    public RealGroupedAggregateStatistics(final int n, final int n2, final int n3, final long n4, final long n5, final long n6, final long n7, final int n8, final int rowsInput, final boolean hasDistinctAggregate, final boolean inSortedOrder, final Properties properties, final double n9, final double n10, final ResultSetStatistics childResultSetStatistics) {
    ...
    public String getNodeName() {
        return MessageService.getTextMessage("43X44.U");
    }
    ...
    public Object getResultSetDescriptor(final Object o, final Object o2, final Object o3, final Object o4, final Object o5, final Object o6) {
        return new XPLAINResultSetDescriptor((UUID)o, this.getRSXplainType(), this.getRSXplainDetails(), new Integer(this.numOpens), null, null, null, (UUID)o2, new Double(this.optimizerEstimatedRowCount), new Double(this.optimizerEstimatedCost), null, null, new Integer(this.rowsInput), new Integer(this.rowsSeen), null, new Integer(this.rowsFiltered), null, null, null, (UUID)o3, (UUID)o4, (UUID)o5, (UUID)o6);
    }
    
    public Object getSortPropsDescriptor(final Object o) {
        return XPLAINUtil.extractSortProps(new XPLAINSortPropsDescriptor((UUID)o, null, null, null, null, null, null, XPLAINUtil.getYesNoCharFromBoolean(this.inSortedOrder), XPLAINUtil.getYesNoCharFromBoolean(this.hasDistinctAggregate)), this.sortProperties);
    }
}
