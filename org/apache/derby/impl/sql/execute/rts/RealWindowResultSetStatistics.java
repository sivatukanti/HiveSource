...
public class RealWindowResultSetStatistics extends RealNoPutResultSetStatistics
{
    ...
    public RealWindowResultSetStatistics(final int n, final int n2, final int n3, final long n4, final long n5, final long n6, final long n7, final int n8, final double n9, final double n10, final ResultSetStatistics childResultSetStatistics) {
    ...
    public String getNodeOn() {
        return MessageService.getTextMessage("43X62.U", "<WINDOW FUNCTION>");
    }
