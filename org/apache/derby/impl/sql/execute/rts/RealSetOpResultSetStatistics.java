...
public class RealSetOpResultSetStatistics extends RealNoPutResultSetStatistics
{
    ...
    public RealSetOpResultSetStatistics(final int opType, final int n, final int n2, final int n3, final long n4, final long n5, final long n6, final long n7, final int n8, final int rowsSeenLeft, final int rowsSeenRight, final int rowsReturned, final double n9, final double n10, final ResultSetStatistics leftResultSetStatistics, final ResultSetStatistics rightResultSetStatistics) {
    ...
    public String getNodeName() {
        return MessageService.getTextMessage((this.opType == 1) ? "INTERSECT" : "EXCEPT");
    }
    ...
    public String getRSXplainDetails() {
        return "(" + this.resultSetNumber + ")" + ((this.opType == 1) ? ", INTERSECT" : ", EXCEPT");
    }
