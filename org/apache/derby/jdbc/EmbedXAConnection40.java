...
final class EmbedXAConnection40 extends EmbedXAConnection implements XAConnection
{
    private final CopyOnWriteArrayList<StatementEventListener> statementEventListeners;
    
    EmbedXAConnection40(final EmbeddedBaseDataSource embeddedBaseDataSource, final ResourceAdapter resourceAdapter, final String s, final String s2, final boolean b) throws SQLException {
        super(embeddedBaseDataSource, resourceAdapter, s, s2, b);
