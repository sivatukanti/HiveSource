...
class MethodWriter extends MethodVisitor
{
    ...
    public void visitFrame(final int n, final int n2, final Object[] array, final int b, final Object[] array2) {
        if (this.M == 0) {
            return;
        }
        if (n == -1) {
            ...
            switch (n) {
                case 0: {
                    this.T = n2;
                    this.v.putByte(255).putShort(b2).putShort(n2);
                    for (int k = 0; k < n2; ++k) {
                        this.a(array[k]);
                    }
                    this.v.putShort(b);
                ...
                case 1: {
                    this.T += n2;
                    this.v.putByte(251 + n2).putShort(b2);
                ...
                case 3: {
                    ...
                    this.v.putByte(251).putShort(b2);
                    break;
                }
                case 4: {
                    if (b2 < 64) {
                        this.v.putByte(64 + b2);
                    }
                    else {
                        this.v.putByte(247).putShort(b2);
                    }
                    this.a(array2[0]);
                    break;
                }
    ...
    public void visitMaxs(final int n, final int t) {
        if (this.K) {
            this.d();
        }
        if (this.M == 0) {
            ...
            while (k != null) {
                ...
                label5.a |= 0x40;
                final int n2 = h2.d.length + label3.g;
                if (n2 > max) {
                    max = n2;
                }
            ...
            for (Label label6 = this.N; label6 != null; label6 = label6.i) {
                ...
                if ((label6.a & 0x40) == 0x0) {
                    ...
                    final int n3 = ((i == null) ? this.r.b : i.c) - 1;
                    if (n3 >= c) {
                        max = Math.max(max, 1);
                        for (int l = c; l < n3; ++l) {
                            this.r.a[l] = 0;
            ...
            if (this.L > 0) {
                ...
                for (Label label8 = this.N; label8 != null; label8 = label8.i) {
                    if ((label8.a & 0x80) != 0x0) {
                        ...
                        if ((b.a & 0x400) == 0x0) {
                            ++n4;
                            b.b(null, n4 / 32L << 32 | 1L << n4 % 32, this.L);
                        }
                    }
                }
            ...
            while (m != null) {
                ...
                while (edge3 != null) {
                    final Label b3 = edge3.b;
                    if ((b3.a & 0x8) == 0x0) {
                        b3.f = ((edge3.a == Integer.MAX_VALUE) ? 1 : (f + edge3.a));
                        final Label label13 = b3;
                        label13.a |= 0x8;
                        b3.k = m;
                        m = b3;
                    }
        ...
        while (true) {
            ...
            switch (this.f.charAt(n++)) {
                ...
                case '[': {
                    ...
                    this.z[a++] = (0x1700000 | this.b.c(this.f.substring(beginIndex, ++n)));
                    continue;
                }
                case 'L': {
                    while (this.f.charAt(n) != ';') {
                    ...
                    this.z[a++] = (0x1700000 | this.b.c(this.f.substring(beginIndex + 1, n++)));
                    continue;
                }
                default: {
                    this.z[1] = a - 3;
