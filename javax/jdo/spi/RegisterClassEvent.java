...
public class RegisterClassEvent extends EventObject
{
    ...
    public RegisterClassEvent(final JDOImplHelper helper, final Class registeredClass, final String[] fieldNames, final Class[] fieldTypes, final byte[] fieldFlags, final Class persistenceCapableSuperclass) {
        super(helper);
